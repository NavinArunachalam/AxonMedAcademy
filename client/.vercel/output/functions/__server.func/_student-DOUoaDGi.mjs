...
import { P as PortalShell } from "./_ssr/PortalShell-BdeD7mdV.mjs";
import { aj as useClassroomStore, P as getMyClassrooms, j as classroomActions } from "./_ssr/router-LScdOZhk.mjs";
