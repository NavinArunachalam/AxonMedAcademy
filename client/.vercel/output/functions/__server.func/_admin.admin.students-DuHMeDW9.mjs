...
import { ap as useClassroomStore, L as getClassrooms, D as getAdminUsers, j as classroomActions, o as createAdminUser, g as addStudentsToClassroom, a4 as messageActions } from "./_ssr/router-b9USinVv.mjs";
import "./_libs/firebase.mjs";
import "./_libs/firebase__messaging.mjs";
import { D as Download, a2 as Plus, as as X, O as LoaderCircle, a9 as Search, ar as Video, R as Mail, q as ChevronUp, n as ChevronDown, w as ClipboardList } from "./_libs/lucide-react.mjs";
    ...
    showAdd && /* @__PURE__ */ jsxRuntimeExports.jsxs(DarkCard, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleAddStudent, className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 pt-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => setShowAdd(false), disabled: isSubmitting, className: "flex-1 rounded-full bg-cream/10 text-cream py-2.5 text-sm font-semibold disabled:opacity-50", children: "Cancel" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "submit", disabled: isSubmitting, className: "flex-1 rounded-full bg-lime text-plum-dark py-2.5 text-sm font-bold flex items-center justify-center gap-2 disabled:opacity-75", children: [
            isSubmitting && /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-4 w-4 animate-spin" }),
