...
import { aj as useClassroomStore, A as getAdminPrograms, C as getAssetUrl, s as deleteAdminProgram, af as updateAdminProgram, m as createAdminProgram } from "./_ssr/router-CMo-f-AL.mjs";
