...
import { aj as useClassroomStore, K as getClassrooms, C as getAdminUsers, ah as updateStudentCertificate, j as classroomActions } from "./_ssr/router-LScdOZhk.mjs";
