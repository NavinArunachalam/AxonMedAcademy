...
import { am as useClassroomStore, m as computeCertificates } from "./_ssr/router-CXHGCxdL.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-5 md:grid-cols-2", children: [
      certs.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl overflow-hidden border border-border bg-white shadow-sm", children: [
        ...
        c.certificateUrl && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border bg-slate-50 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2 mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: c.certificateUrl, target: "_blank", rel: "noreferrer", download: isSameOrigin(c.certificateUrl) ? "Certificate.pdf" : void 0, className: "inline-flex items-center gap-2 rounded-full bg-lime text-plum-dark px-4 py-2 text-xs font-semibold hover:bg-lime/90 shadow-sm transition-colors", children: [
