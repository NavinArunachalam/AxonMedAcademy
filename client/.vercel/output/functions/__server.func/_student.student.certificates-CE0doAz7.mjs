...
import { i as useClassroomStore, d as computeCertificates } from "./_ssr/classroomStore-B40uasVO.mjs";
import { ab as ShieldCheck, f as Award, aa as Share2, D as Download, O as Lock } from "./_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-5 md:grid-cols-2", children: [
      certs.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl overflow-hidden border border-border bg-white shadow-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex items-center justify-between bg-slate-50 border-t border-border", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "grid h-9 w-9 place-items-center rounded-full border border-border bg-white text-plum-dark hover:bg-slate-100 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Share2, { className: "h-4 w-4" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: handlePrint, className: "inline-flex items-center gap-2 rounded-full bg-plum-dark text-cream px-4 py-2 text-xs font-semibold hover:bg-plum shadow-sm transition-colors", children: [
