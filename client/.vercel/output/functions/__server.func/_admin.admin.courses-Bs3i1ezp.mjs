...
import { V as useClassroomStore, u as getAdminPrograms, o as deleteAdminProgram, S as updateAdminProgram, j as createAdminProgram } from "./_ssr/router-B6mcLJS0.mjs";
import { g as BookOpen, a3 as RefreshCw, a0 as Plus, ak as TrendingUp, I as IndianRupee, M as LoaderCircle, q as CircleAlert, X as Pen, aj as Trash2, aq as X } from "./_libs/lucide-react.mjs";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
          ...
          filteredCourses.map((c) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-t border-cream/10 hover:bg-cream/5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: c.status, onChange: (e) => handleStatusChange(c.id, e.target.value), className: "bg-cream/5 border border-cream/10 rounded-lg px-2 py-1 text-cream/70 text-xs outline-none", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "published", children: "Published" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "draft", children: "Draft" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "archived", children: "Archived" })
              ] }) }),
