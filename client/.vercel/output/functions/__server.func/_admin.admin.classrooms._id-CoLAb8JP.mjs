...
import { D as DarkCard } from "./_ssr/PortalShell-DpJHKv_h.mjs";
import { c as Route$2, ak as useClassroomStore, G as getClassroomById, i as classroomActions, a0 as markClassroomFresh, X as isClassroomStale, U as getRecordingStreamUrl, y as formatDuration, ae as unpublishRecording, a3 as publishRecording, w as deleteRecording, T as getQuizReport, ai as uploadClassroomFileToCloudinary, p as createClassroomAnnouncement, t as deleteClassroomAnnouncement, q as createMeeting, a9 as startMeeting, x as endMeeting, u as deleteMeeting, a5 as reuseClassroomRecording, aj as uploadClassroomRecordingToCloudflare, ad as uid, ah as updateQuiz, r as createQuiz, a2 as publishQuiz, k as closeQuiz, v as deleteQuiz, B as getAdminUsers, f as addStudentsToClassroom, ag as updateClassroomStudentStatus } from "./_ssr/router-DSLNBAbv.mjs";
      ...
      cls.announcements.map((ann) => /* @__PURE__ */ jsxRuntimeExports.jsx(DarkCard, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 flex-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
            ...
            ann.attachments && ann.attachments.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 flex flex-wrap gap-2", children: ann.attachments.map((at, i) => {
              const proxyUrl = at.url?.includes("res.cloudinary.com") ? `/api/v1/classrooms/files?url=${encodeURIComponent(at.url)}` : at.url;
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: proxyUrl, target: "_blank", rel: "noreferrer", download: at.name, className: "inline-flex items-center gap-2 bg-cream/5 border border-cream/10 rounded-lg px-3 py-2 text-xs font-semibold text-cream/70 hover:bg-cream/10 hover:text-lime transition-all", children: [
