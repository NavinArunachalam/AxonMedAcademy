...
import { ao as useClassroomStore, K as getClassrooms, C as getAdminUsers, al as updateStudentCertificate, j as classroomActions } from "./_ssr/router-Cwn_fQeX.mjs";
