...
import { V as useClassroomStore, x as getClassrooms, f as classroomActions, u as getAdminPrograms, k as createClassroom } from "./_ssr/router-B6mcLJS0.mjs";
import { L as Link } from "./_libs/tanstack__react-router.mjs";
import { a6 as School, a0 as Plus, a8 as Search, aq as X, M as LoaderCircle, ao as Users, ap as Video, g as BookOpen, u as ClipboardList, o as ChevronRight, a as Archive } from "./_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DarkCard, { className: "w-full max-w-lg", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        }), className: "w-full bg-cream/5 border border-cream/10 rounded-xl px-4 py-2.5 text-cream text-sm outline-none focus:border-lime/50", children: programs.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: p.title, children: [
          p.title,
