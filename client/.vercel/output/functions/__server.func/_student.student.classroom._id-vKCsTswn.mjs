...
import { i as useClassroomStore, f as formatDuration, c as classroomActions } from "./_ssr/classroomStore-B40uasVO.mjs";
import { b as Route$1 } from "./_ssr/router-JxSG1n5K.mjs";
import { O as Lock, c as ArrowLeft, R as Megaphone, ap as Video, a2 as Radio, C as Calendar, v as Clock, g as BookOpen, $ as Play, u as ClipboardList, l as Check, aq as X, al as Trophy } from "./_libs/lucide-react.mjs";
    ...
    upcoming.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: upcoming.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `rounded-2xl border p-5 ${m.status === "live" ? "border-red-200 bg-red-50" : "border-slate-200 bg-white"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3 flex-wrap", children: [
        ...
        m.status === "live" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `/student/jitsi/${m.roomId}`, className: "rounded-full bg-red-500 text-white px-5 py-2.5 text-sm font-bold flex items-center gap-2 shrink-0", children: [
          ...
          " Join Now"
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-full bg-slate-100 text-slate-500 px-4 py-2 text-xs font-semibold shrink-0", children: "Scheduled" })
      ] }) }, m.id)) })
    ] }),
...
function SecurePlayer({
  ...
  const streamUrl = recording.storageProvider === "cloudflare" ? `/api/v1/recordings/classroom/${recording.id}/stream` : recording.cloudflareUrl;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-50 bg-black flex flex-col", onContextMenu: (e) => e.preventDefault(), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-5 py-3 bg-black/80", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-white/30 text-xs font-mono", children: [
          CURRENT_STUDENT.name,
          " · ",
          CURRENT_STUDENT.id.slice(-8)
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onClose, className: "text-white/60 hover:text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-5 w-5" }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 relative select-none", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 bg-linear-to-br from-plum-dark/90 to-[#0B0719] flex items-center justify-center relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-4 right-4 text-white/20 text-xs font-mono pointer-events-none select-none", children: [
          CURRENT_STUDENT.name,
          " · SECURE"
        ] }),
        streamUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx("video", { ref: videoRef, src: streamUrl, className: "w-full h-full object-contain bg-black", controls: true, poster: "/default-video-thumb.jpg", onPlay: () => setIsPlaying(true), onPause: () => setIsPlaying(false) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
          if (blurred) return;
          setIsPlaying((p) => !p);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-black px-5 py-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/60 text-xs font-mono", children: fmt(position) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-1.5 bg-white/20 rounded-full cursor-pointer", onClick: (e) => {
          const rect = e.currentTarget.getBoundingClientRect();
          const pct2 = (e.clientX - rect.left) / rect.width;
          setPosition(Math.floor(pct2 * recording.duration));
        }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full bg-lime rounded-full transition-all", style: {
          width: `${pct}%`
        } }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/60 text-xs font-mono", children: fmt(recording.duration) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mt-1 text-white/30 text-[10px]", children: "🔒 This video is protected. Downloading, recording, or sharing is prohibited." })
    ] })
  ] });
}
  ...
  if (phase === "intro" && activeQuiz) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-slate-200 bg-white p-8 text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setPhase("taking"), className: "flex-1 rounded-full bg-plum-dark text-cream py-3 text-sm font-bold", children: "Start Quiz →" })
      ] })
    ] }) });
  }
  if (phase === "taking" && activeQuiz) {
    activeQuiz.questions.reduce((s, q) => s + q.marks, 0);
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      ...
      activeQuiz.questions.map((q, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-slate-200 bg-white p-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-slate-200 bg-white p-5 flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-slate-500 text-sm", children: answered < activeQuiz.questions.length ? `${activeQuiz.questions.length - answered} question${activeQuiz.questions.length - answered !== 1 ? "s" : ""} unanswered` : "All questions answered ✓" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: submitQuiz, className: "rounded-full bg-plum-dark text-cream px-8 py-3 text-sm font-bold hover:bg-plum transition-colors", children: "Submit Quiz" })
      ] })
    ] });
  }
        ...
        activeQuiz.questions.map((q, i) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `rounded-2xl border p-5 ${myAns?.isCorrect ? "border-green-200 bg-green-50" : "border-red-200 bg-red-50"}`, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-slate-600 ml-8", children: [
              ...
              " · Correct: ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-green-700", children: correct.join(", ") })
            ] }),
            q.explanation && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-slate-500 ml-8 mt-2 italic", children: [
              "💡 ",
              q.explanation
            ] })
          ] }, q.id);
