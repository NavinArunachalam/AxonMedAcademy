import { R as React__default, r as reactExports, j as jsxRuntimeExports } from "./_libs/react.mjs";
...
import { D as DarkCard } from "./_ssr/PortalShell-BLPF8Jzh.mjs";
import { c as Route, a0 as useClassroomStore, x as getClassroomById, f as classroomActions, L as markClassroomFresh, I as isClassroomStale, H as getRecordingStreamUrl, t as formatDuration, X as unpublishRecording, O as publishRecording, s as deleteRecording, G as getQuizReport, m as createClassroomAnnouncement, q as deleteClassroomAnnouncement, n as createMeeting, Q as reuseClassroomRecording, $ as uploadClassroomRecordingToCloudflare, W as uid, _ as updateQuiz, o as createQuiz, N as publishQuiz, h as closeQuiz, r as deleteQuiz, w as getAdminUsers, d as addStudentsToClassroom, Z as updateClassroomStudentStatus } from "./_ssr/router-CbIg4qJV.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: cls.quizzes.map((q) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx(DarkCard, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3 flex-wrap", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => handleDownloadQuiz(q, "json"), className: "rounded-full bg-cream/10 text-cream px-2.5 py-1.5 text-xs font-semibold flex items-center gap-1 hover:bg-cream/20 transition-colors", title: "Download Quiz as JSON", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(LuDownload, { className: "h-3.5 w-3.5" }),
            " JSON"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => handleDownloadQuiz(q, "txt"), className: "rounded-full bg-cream/10 text-cream px-2.5 py-1.5 text-xs font-semibold flex items-center gap-1 hover:bg-cream/20 transition-colors", title: "Download Quiz as TXT (Printable)", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(LuDownload, { className: "h-3.5 w-3.5" }),
            " TXT"
          ] }),
