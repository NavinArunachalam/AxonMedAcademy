...
import { d as Route$2, ar as useClassroomStore, K as getClassroomById, k as classroomActions, a4 as markClassroomFresh, $ as isClassroomStale, Y as getRecordingStreamUrl, A as formatDuration, ai as unpublishRecording, a7 as publishRecording, y as deleteRecording, X as getQuizReport, r as createClassroomAnnouncement, v as deleteClassroomAnnouncement, s as createMeeting, ad as startMeeting, z as endMeeting, w as deleteMeeting, a8 as reuseClassroomRecording, ap as uploadClassroomRecordingToCloudflare, ah as uid, C as generateQuizFromPdf, an as updateQuiz, t as createQuiz, a6 as publishQuiz, m as closeQuiz, x as deleteQuiz, E as getAdminUsers, g as addStudentsToClassroom, al as updateClassroomStudentStatus } from "./_ssr/router-CFicUlxS.mjs";
...
function LiveClassesTab({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
    ...
    past.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DarkCard, { className: "p-0 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full min-w-162.5 text-sm", children: [
...
function StudentsTab({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(DarkCard, { className: "p-0 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full min-w-175 text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-cream/5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "text-[10px] uppercase tracking-widest text-cream/60 text-left", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "p-4", children: "Student" }),
...
function AdminClassroomDetail() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 text-cream", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 overflow-x-auto bg-cream/5 rounded-2xl p-1.5 whitespace-nowrap [-ms-overflow-style:none] scrollbar-none [&::-webkit-scrollbar]:hidden", children: TABS.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setTab(t.key), className: `shrink-0 inline-flex items-center justify-center gap-1.5 text-xs sm:text-sm font-semibold rounded-xl px-3.5 py-2 transition-colors ${tab === t.key ? "bg-lime text-plum-dark" : "text-cream/70 hover:text-cream"}`, children: [
