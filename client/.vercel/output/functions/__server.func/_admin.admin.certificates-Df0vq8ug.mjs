...
import { am as useClassroomStore, K as getClassrooms, C as getAdminUsers, ak as updateStudentCertificate, j as classroomActions } from "./_ssr/router-BgLlorBt.mjs";
