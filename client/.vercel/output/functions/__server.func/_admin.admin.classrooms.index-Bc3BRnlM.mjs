...
import { ar as useClassroomStore, k as classroomActions, M as getClassrooms, D as getAdminPrograms, j as archiveClassroom, q as createClassroom, ak as updateClassroom } from "./_ssr/router-Dlc6vLg3.mjs";
import { L as Link } from "./_libs/tanstack__react-router.mjs";
import "./_libs/firebase.mjs";
import "./_libs/firebase__messaging.mjs";
import { a9 as School, a4 as Plus, ab as Search, au as X, P as LoaderCircle, as as Users, at as Video, h as BookOpen, x as ClipboardList, q as ChevronRight, a0 as Pencil, a as Archive, b as ArchiveRestore } from "./_libs/lucide-react.mjs";
...
function EditClassroomModal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DarkCard, { className: "w-full max-w-lg max-h-[90vh] overflow-y-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-xl font-bold text-cream", children: "Edit Classroom" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onClose, className: "text-cream/50 hover:text-cream", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-5 w-5" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
      submitError && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 bg-red-500/10 border border-red-500/20 rounded-xl text-red-400 text-xs", children: submitError }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[11px] uppercase tracking-widest text-cream/60 block mb-1", children: "Classroom Name *" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { required: true, value: form.name, onChange: (e) => setForm({
          ...form,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        loadingPrograms ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-4 py-2.5 bg-cream/5 border border-cream/10 rounded-xl text-cream/50 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-3.5 w-3.5 animate-spin" }),
          "Loading programs…"
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: form.program, onChange: (e) => setForm({
          ...form,
          program: e.target.value
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "— No program —" }),
          programs.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: p.title, children: [
            p.title,
            p.category ? ` — ${p.category}` : ""
          ] }, p.id))
        ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 pt-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: onClose, className: "flex-1 rounded-full bg-cream/10 text-cream py-2.5 text-sm font-semibold", children: "Cancel" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", disabled: isSubmitting, className: "flex-1 rounded-full bg-lime text-plum-dark py-2.5 text-sm font-bold disabled:opacity-50", children: isSubmitting ? "Saving..." : "Save Changes" })
      ] })
    ] })
  ] }) });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl bg-[#1A0F33] border border-cream/10 overflow-hidden hover:border-lime/30 transition-colors group", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => onEdit(cls), className: "rounded-full bg-cream/10 text-cream/70 px-3 py-2 hover:bg-lime/20 hover:text-lime transition-colors", title: "Edit classroom", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Pencil, { className: "h-3.5 w-3.5" }) }),
        cls.status !== "archived" ? /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => onArchive(cls.id), className: "rounded-full bg-cream/10 text-cream/70 px-3 py-2 hover:bg-orange-500/20 hover:text-orange-400 transition-colors", title: "Archive classroom", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Archive, { className: "h-3.5 w-3.5" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => onArchive(cls.id), className: "rounded-full bg-cream/10 text-cream/70 px-3 py-2 hover:bg-lime/20 hover:text-lime transition-colors", title: "Unarchive classroom (set active)", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArchiveRestore, { className: "h-3.5 w-3.5" }) })
      ] })
    ] })
  ] });
}
...
function AdminClassrooms() {
  ...
  const [filterStatus, setFilterStatus] = reactExports.useState("active");
  const [editingClassroom, setEditingClassroom] = reactExports.useState(null);
  const [archiveLoading, setArchiveLoading] = reactExports.useState(null);
  ...
  const handleArchive = async (id) => {
    ...
    setFeedback(null);
    try {
      const updated = await archiveClassroom(id);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 text-cream", children: [
    ...
    editingClassroom && /* @__PURE__ */ jsxRuntimeExports.jsx(EditClassroomModal, { classroom: editingClassroom, onClose: () => setEditingClassroom(null), onUpdated: (updated) => {
      classroomActions.updateClassroom(editingClassroom.id, updated);
      listLastFetchedAt = 0;
    } }),
    feedback && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border border-lime/30 bg-lime/10 px-4 py-3 text-sm text-lime shadow-lg", children: feedback }),
    ...
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 sm:grid-cols-2 xl:grid-cols-3", children: filtered.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(ClassroomCard, { cls: c, onEdit: handleEdit, onArchive: handleArchive }, c.id)) })
  ] });
}
export {
