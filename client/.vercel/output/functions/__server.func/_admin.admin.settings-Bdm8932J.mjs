...
import { i as api, D as getAssetUrl } from "./_ssr/router-C0aDfAXV.mjs";
import { D as DarkCard } from "./_ssr/PortalShell-DtwwmfcP.mjs";
import { i as Building2, a4 as Save, g as BookOpen, a0 as Plus, X as Pen, ai as Trash2, ao as Users, aq as X, am as Upload, af as Star, F as FileText, P as Mail, U as MessageSquare, l as Check } from "./_libs/lucide-react.mjs";
...
function Settings() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 text-cream pb-12", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 lg:grid-cols-[220px_1fr]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("aside", { className: "space-y-1", children: ["Organization", "About", "Faculty", "Placement", "Blog", "Contact"].map((tab) => {
