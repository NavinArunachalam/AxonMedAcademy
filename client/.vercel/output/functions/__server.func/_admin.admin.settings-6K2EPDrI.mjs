...
import { ar as useClassroomStore, i as api, F as getAssetUrl } from "./_ssr/router-CFicUlxS.mjs";
import { D as DarkCard } from "./_ssr/PortalShell-BbXObVDa.mjs";
import "./_libs/firebase.mjs";
import "./_libs/firebase__messaging.mjs";
import { j as Building2, am as Trash2, a8 as Save, h as BookOpen, a4 as Plus, _ as Pen, as as Users, au as X, aq as Upload, aj as Star, G as FileText, n as Check, a3 as Play } from "./_libs/lucide-react.mjs";
...
function Settings() {
  ...
  if (currentUser?.role === "faculty") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate, { to: "/admin/classrooms" });
  }
  ...
  const [isLoadingOrg, setIsLoadingOrg] = reactExports.useState(false);
  const [isSavingOrg, setIsSavingOrg] = reactExports.useState(false);
  const applyOrgDetails = (contactDetails) => {
    setOrg((current) => ({
      ...current,
  ...
  const [blogImagePreview, setBlogImagePreview] = reactExports.useState(null);
  const blogImageRef = reactExports.useRef(null);
  const [voicesSubTab, setVoicesSubTab] = reactExports.useState("Reviews");
  ...
  const [isAddingTestimonial, setIsAddingTestimonial] = reactExports.useState(false);
  const [testimonialImageFile, setTestimonialImageFile] = reactExports.useState(null);
  const [testimonialImagePreview, setTestimonialImagePreview] = reactExports.useState(null);
  const testimonialImageRef = reactExports.useRef(null);
  const [isLoadingTestimonials, setIsLoadingTestimonials] = reactExports.useState(false);
  const [reviewVideos, setReviewVideos] = reactExports.useState([]);
  const [editingVideo, setEditingVideo] = reactExports.useState(null);
  const [isAddingVideo, setIsAddingVideo] = reactExports.useState(false);
  ...
  const [isLoadingVideos, setIsLoadingVideos] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 text-cream pb-12", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 lg:grid-cols-[220px_1fr]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("aside", { className: "space-y-1", children: ["Organization", "About", "Faculty", "Placement", "Blog", "Voices"].map((tab) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        activeTab === "Organization" && /* @__PURE__ */ jsxRuntimeExports.jsxs(DarkCard, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-cream/60 mt-1", children: "General public information about Axon Med Academy" }),
              isLoadingOrg && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-lime mt-1", children: "Loading saved details..." })
            ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSaveOrg, className: "space-y-5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-7 flex justify-end gap-3 border-t border-cream/10 pt-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: handleResetOrg, className: "inline-flex items-center gap-2 rounded-full border border-cream/15 px-5 py-2.5 text-sm font-bold text-cream/80 hover:bg-cream/10", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "h-4 w-4" }),
                " Reset"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "submit", disabled: isSavingOrg, className: "inline-flex items-center gap-2 rounded-full bg-lime text-plum-dark px-5 py-2.5 text-sm font-bold shadow hover:opacity-90 disabled:opacity-60", children: [
        ...
        activeTab === "Faculty" && /* @__PURE__ */ jsxRuntimeExports.jsxs(DarkCard, { children: [
          ...
          editingFaculty || isAddingFaculty ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 border-t border-cream/10 pt-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] uppercase tracking-widest text-cream/60", children: "Email (for login)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "email", value: editingFaculty.email, onChange: (e) => setEditingFaculty({
                  ...editingFaculty,
                  email: e.target.value
                }), className: "mt-1.5 w-full bg-cream/5 border border-cream/10 rounded-xl px-4 py-2.5 text-sm outline-none focus:border-lime", placeholder: "e.g. dr.anita@axon.academy" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] uppercase tracking-widest text-cream/60", children: "Password (for login)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", value: editingFaculty.password, onChange: (e) => setEditingFaculty({
                  ...editingFaculty,
                  password: e.target.value
                }), className: "mt-1.5 w-full bg-cream/5 border border-cream/10 rounded-xl px-4 py-2.5 text-sm outline-none focus:border-lime", placeholder: "Set a password for faculty login" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        activeTab === "Blog" && /* @__PURE__ */ jsxRuntimeExports.jsxs(DarkCard, { children: [
          ...
          editingPost || isAddingPost ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 border-t border-cream/10 pt-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative shrink-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-24 w-40 overflow-hidden rounded-2xl bg-cream/5 border-2 border-dashed border-cream/10 grid place-items-center", children: blogImagePreview ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: blogImagePreview, alt: "Preview", className: "h-full w-full object-cover" }) : editingPost?.image ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: getAssetUrl(editingPost.image), alt: "Current", className: "h-full w-full object-cover" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "h-8 w-8 text-cream/10" }) }),
                (blogImagePreview || editingPost?.image) && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => blogImageRef.current?.click(), className: "inline-flex items-center gap-2 rounded-full bg-cream/10 hover:bg-cream/20 text-cream border border-cream/10 px-4 py-2 text-xs font-bold transition-colors", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { className: "h-3.5 w-3.5" }),
                  blogImagePreview || editingPost?.image ? "Change Image" : "Upload Image"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-cream/30 uppercase tracking-[0.15em]", children: "JPG, PNG or WebP · Max 2MB" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("input", { ref: blogImageRef, type: "file", accept: "image/*", className: "hidden", onChange: (e) => {
                  const file = e.target.files?.[0];
                  if (file) {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
              post.image && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0 w-14 h-14 rounded-xl overflow-hidden bg-cream/5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: getAssetUrl(post.image), alt: "", className: "h-full w-full object-cover" }) }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1 shrink-0 opacity-40 group-hover:opacity-100 transition-opacity", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
                ...
                setBlogImageFile(null);
                setBlogImagePreview(null);
              }, className: "p-1 hover:bg-cream/10 rounded text-cream", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Pen, { className: "h-3.5 w-3.5" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: async () => {
        ...
        activeTab === "Voices" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 border-b border-cream/10 pb-1", children: ["Reviews", "Videos"].map((sub) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setVoicesSubTab(sub), className: `px-4 py-2 text-sm font-semibold rounded-t-lg transition-colors ${voicesSubTab === sub ? "bg-lime text-plum-dark" : "text-cream/60 hover:text-cream"}`, children: sub === "Reviews" ? "Student Reviews" : "Review Videos" }, sub)) }),
          voicesSubTab === "Reviews" && /* @__PURE__ */ jsxRuntimeExports.jsxs(DarkCard, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-lg", children: "Student Reviews" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-cream/60 mt-1", children: "Manage testimonials shown on the home page Voices section" })
              ] }),
              !editingTestimonial && !isAddingTestimonial && /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => {
            ...
            editingTestimonial || isAddingTestimonial ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 border-t border-cream/10 pt-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-sm text-lime", children: isAddingTestimonial ? "Add Student Review" : "Edit Student Review" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative shrink-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-20 w-20 overflow-hidden rounded-2xl bg-cream/5 border-2 border-dashed border-cream/10 grid place-items-center", children: testimonialImagePreview ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: testimonialImagePreview, alt: "Preview", className: "h-full w-full object-cover" }) : editingTestimonial?.image ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: editingTestimonial.image, alt: "Current", className: "h-full w-full object-cover" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "h-7 w-7 text-cream/10" }) }),
                  (testimonialImagePreview || editingTestimonial?.image) && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => {
                    setTestimonialImageFile(null);
                    setTestimonialImagePreview(null);
                  ...
                  }, className: "absolute -top-1.5 -right-1.5 h-5 w-5 rounded-full bg-red-500 text-white grid place-items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-3 w-3" }) })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => testimonialImageRef.current?.click(), className: "inline-flex items-center gap-2 rounded-full bg-cream/10 hover:bg-cream/20 text-cream border border-cream/10 px-3 py-1.5 text-xs font-bold", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { className: "h-3.5 w-3.5" }),
                    testimonialImagePreview || editingTestimonial?.image ? "Change Photo" : "Upload Photo"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-cream/30 uppercase tracking-[0.15em]", children: "JPG, PNG or WebP · Max 2MB" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("input", { ref: testimonialImageRef, type: "file", accept: "image/*", className: "hidden", onChange: (e) => {
                    const file = e.target.files?.[0];
                    if (file) {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] uppercase tracking-widest text-cream/60", children: "Student Name" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", value: editingTestimonial.name, onChange: (e) => setEditingTestimonial({
                    ...editingTestimonial,
                    name: e.target.value
                  }), className: "mt-1.5 w-full bg-cream/5 border border-cream/10 rounded-xl px-4 py-2.5 text-sm outline-none focus:border-lime", placeholder: "e.g. Priya Krishnan" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] uppercase tracking-widest text-cream/60", children: "Roll / Current Role" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", value: editingTestimonial.roll, onChange: (e) => setEditingTestimonial({
                    ...editingTestimonial,
                    roll: e.target.value
                  }), className: "mt-1.5 w-full bg-cream/5 border border-cream/10 rounded-xl px-4 py-2.5 text-sm outline-none focus:border-lime", placeholder: "e.g. Staff Nurse · Apollo Hospitals" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sm:col-span-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] uppercase tracking-widest text-cream/60", children: "Review Text" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { value: editingTestimonial.review, onChange: (e) => setEditingTestimonial({
                    ...editingTestimonial,
                    review: e.target.value
                  }), className: "mt-1.5 w-full bg-cream/5 border border-cream/10 rounded-xl px-4 py-3 text-sm outline-none focus:border-lime min-h-[80px]", placeholder: "What the student said about the academy..." })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-2.5 mt-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => {
                  setEditingTestimonial(null);
                  setIsAddingTestimonial(false);
                  setTestimonialImageFile(null);
                ...
                }, className: "px-4 py-2 bg-lime text-plum-dark text-xs font-bold rounded-full", children: "Save Review" })
              ] })
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 grid gap-4 sm:grid-cols-2", children: isLoadingTestimonials ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-2 text-center py-8 text-sm text-cream/50", children: "Loading reviews..." }) : testimonials.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-2 text-center py-8 text-sm text-cream/50", children: "No student reviews yet. Add your first review!" }) : testimonials.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 p-4 rounded-2xl bg-cream/5 border border-cream/10 relative group", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl overflow-hidden flex items-center justify-center bg-plum-dark shrink-0 border border-cream/10", children: t.image ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: t.image, alt: t.name, className: "h-full w-full object-cover" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-lime text-base", children: t.name.charAt(0) }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 pr-14", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-sm text-cream", children: t.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-lime font-medium", children: t.roll }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-cream/60 line-clamp-2", children: [
                  '"',
                  t.review,
                  '"'
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-3 right-3 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
                  setEditingTestimonial(t);
                  setTestimonialImageFile(null);
                  setTestimonialImagePreview(null);
          ...
          voicesSubTab === "Videos" && /* @__PURE__ */ jsxRuntimeExports.jsxs(DarkCard, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-lg", children: "Review Videos" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-cream/60 mt-1", children: "Upload student video testimonials to Cloudflare R2" })
              ] }),
              !editingVideo && !isAddingVideo && /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => {
            ...
            editingVideo || isAddingVideo ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 border-t border-cream/10 pt-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-sm text-lime", children: isAddingVideo ? "Upload New Review Video" : "Edit Video Details" }),
              isAddingVideo && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] uppercase tracking-widest text-cream/60", children: "Video File (MP4 / MOV / WebM)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { onClick: () => videoFileRef.current?.click(), className: "mt-1.5 cursor-pointer flex flex-col items-center justify-center gap-2 h-28 rounded-2xl bg-cream/5 border-2 border-dashed border-cream/10 hover:border-lime/50 transition-colors", children: videoFile ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-6 w-6 text-lime mx-auto mb-1" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-lime", children: videoFile.name }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { className: "h-6 w-6 text-cream/20" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-cream/40", children: "Click to select a video file" })
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("input", { ref: videoFileRef, type: "file", accept: "video/*", className: "hidden", onChange: (e) => {
                  const file = e.target.files?.[0];
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-3 gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sm:col-span-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] uppercase tracking-widest text-cream/60", children: "Video Title" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", value: editingVideo.title, onChange: (e) => setEditingVideo({
                    ...editingVideo,
                    title: e.target.value
                  }), className: "mt-1.5 w-full bg-cream/5 border border-cream/10 rounded-xl px-4 py-2.5 text-sm outline-none focus:border-lime", placeholder: "e.g. My journey from student to staff nurse" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] uppercase tracking-widest text-cream/60", children: "Student Name" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", value: editingVideo.studentName, onChange: (e) => setEditingVideo({
                    ...editingVideo,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sm:col-span-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] uppercase tracking-widest text-cream/60", children: "Roll / Current Role" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", value: editingVideo.roll, onChange: (e) => setEditingVideo({
                    ...editingVideo,
                    roll: e.target.value
                  }), className: "mt-1.5 w-full bg-cream/5 border border-cream/10 rounded-xl px-4 py-2.5 text-sm outline-none focus:border-lime", placeholder: "e.g. Staff Nurse · Apollo Hospitals" })
                ] })
              ] }),
              isUploadingVideo && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-lime/10 border border-lime/20 px-4 py-3 text-xs font-semibold text-lime flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "animate-spin inline-block h-3 w-3 border-2 border-lime border-t-transparent rounded-full" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-2.5 mt-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", disabled: isUploadingVideo, onClick: async () => {
                  if (!editingVideo.title) {
                    alert("Please fill the video title");
                    return;
                  }
                ...
                }, className: "px-4 py-2 bg-lime text-plum-dark text-xs font-bold rounded-full disabled:opacity-50 disabled:cursor-not-allowed", children: isAddingVideo ? isUploadingVideo ? "Uploading..." : "Upload to R2" : "Save Details" })
              ] })
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 divide-y divide-cream/5", children: isLoadingVideos ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-8 text-sm text-cream/50", children: "Loading review videos..." }) : reviewVideos.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-8 text-sm text-cream/50", children: "No review videos yet. Upload your first video!" }) : reviewVideos.map((v) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-3.5 flex items-center justify-between gap-4 group", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0 w-10 h-10 rounded-xl bg-plum-dark border border-cream/10 grid place-items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "h-4 w-4 fill-lime text-lime" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-sm text-cream truncate", children: v.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-cream/55 flex items-center gap-1.5", children: [
                    v.studentName && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: v.studentName }),
                    v.studentName && v.roll && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "·" }),
                    v.roll && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lime/80", children: v.roll })
                  ] })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1 shrink-0 opacity-40 group-hover:opacity-100 transition-opacity", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setEditingVideo(v), className: "p-1 hover:bg-cream/10 rounded text-cream", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Pen, { className: "h-3 w-3" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: async () => {
