...
import { c as Route$3, ap as useClassroomStore, _ as isClassroomStale, J as getClassroomById, j as classroomActions, a3 as markClassroomFresh, z as formatDuration, aa as saveQuizAnswer, ae as submitQuizAttempt, V as getQuizAttemptResult, X as getRecordingStreamUrl, af as trackRecordingProgress, ad as startQuizAttempt } from "./_ssr/router-C73_oHkz.mjs";
import "./_libs/firebase.mjs";
import "./_libs/firebase__messaging.mjs";
import { P as Lock, c as ArrowLeft, T as Megaphone, D as Download, ar as Video, a4 as Radio, C as Calendar, x as Clock, g as BookOpen, a1 as Play, w as ClipboardList, m as Check, as as X, an as Trophy, ac as ShieldAlert } from "./_libs/lucide-react.mjs";
      ...
      publishedQuizzes.map((q) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border border-slate-200 bg-white p-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4 flex-wrap", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 shrink-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => startQuiz(q), disabled: !canAttempt, className: `rounded-full px-2 py-2.5 text-sm font-bold ${canAttempt ? "bg-plum-dark text-cream hover:bg-plum" : "bg-slate-100 text-slate-400 cursor-not-allowed"}`, children: !canAttempt ? "Completed" : myAttempts.length > 0 ? "Retry" : "Start Quiz" })
          ] })
        ] }) }, q.id);
      })
    ] });
