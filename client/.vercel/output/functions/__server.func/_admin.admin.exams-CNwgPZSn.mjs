...
import { G as useClassroomStore, s as getExamType, t as getGrade, f as classroomActions } from "./_ssr/router-CuPinYbg.mjs";
import { c as ArrowLeft, k as ChartNoAxesColumn, g as BookOpen, u as ClipboardList, q as CircleAlert, ap as Users, r as CircleCheck } from "./_libs/lucide-react.mjs";
...
function AdminExams() {
  ...
  if (viewQuizId) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 text-cream", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        q.status === "closed" && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
          classroomActions.updateQuizStatus(q.classroomId, q.id, "published");
          setViewQuizId(null);
        }, className: "rounded-full bg-lime text-plum-dark px-4 py-2 text-xs font-bold", children: "Re-open Exam" }),
        q.status === "published" && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
          classroomActions.updateQuizStatus(q.classroomId, q.id, "closed");
        }, className: "rounded-full bg-cream/10 text-cream px-4 py-2 text-xs font-semibold", children: "Close Exam" })
      ] }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 text-cream", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("select", { value: batchFilter, onChange: (e) => setBatchFilter(e.target.value), className: "bg-cream/5 border border-cream/10 rounded-full px-4 py-2 text-sm text-cream outline-none", children: batches.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: b, children: b === "All" ? "All Batches" : b }, b)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("select", { value: statusFilter, onChange: (e) => setStatusFilter(e.target.value), className: "bg-cream/5 border border-cream/10 rounded-full px-4 py-2 text-sm text-cream outline-none", children: statuses.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: s, className: "capitalize", children: s === "All" ? "All Statuses" : s }, s)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DarkCard, { className: "p-0 overflow-hidden", children: [
