...
import { C as Card } from "./_ssr/PortalShell-cVJ2Rj2k.mjs";
import { am as useClassroomStore, h as adminActions } from "./_ssr/router-D3axDpif.mjs";
import "./_libs/firebase.mjs";
import "./_libs/firebase__messaging.mjs";
import { am as User, P as Mail, Y as Phone, Q as MapPin, G as GraduationCap, h as Briefcase, ap as X, a3 as Save } from "./_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mx-auto max-w-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl bg-gradient-to-br from-plum-dark via-plum to-[#1a0a2e] text-cream p-6 shadow-2xl border border-white/10 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-start justify-center mb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-[0.2em] text-lime font-bold mb-1 text-center", children: "Axon ACADEMY" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24 h-28 sm:w-28 sm:h-32 rounded-xl bg-gradient-to-br from-lime/30 to-lime/10 border-2 border-lime/40 shadow-lg flex items-center justify-center overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "h-10 w-10 sm:h-12 sm:w-12 text-lime mx-auto mb-1" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-lime/80 font-medium uppercase tracking-wider", children: "No Photo" })
            ] }) }),
