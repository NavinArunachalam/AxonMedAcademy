...
import { C as Card } from "./_ssr/PortalShell-232oUaaL.mjs";
import { i as useClassroomStore } from "./_ssr/classroomStore-B40uasVO.mjs";
import { k as getMyMeetings } from "./_ssr/api-GlGI6V_B.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: upcoming.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 rounded-xl border border-border p-4 hover:bg-secondary/30 transition-colors", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
          ...
          m.status === "live" && /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: `/student/jitsi/${m.roomId}`, className: "rounded-full bg-orange-500 text-white text-xs font-bold px-4 py-2 animate-pulse inline-flex", children: "Join Now" })
        ] })
      ] }, m.id)) })
    ] }),
