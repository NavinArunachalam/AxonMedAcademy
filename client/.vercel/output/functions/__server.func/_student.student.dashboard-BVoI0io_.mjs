...
import { S as StatTile, C as Card$1 } from "./_ssr/PortalShell-O6BcU29T.mjs";
import { ak as useClassroomStore, Q as getMyMeetings, M as getDetailedProgress, S as getMyNotifications } from "./_ssr/router-BvvC6MMt.mjs";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card$1, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-4 space-y-3", children: [
          upcomingEvents.map((e) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-4 rounded-xl border border-border p-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `/live/${e.roomId}`, className: `text-xs font-semibold rounded-full px-3 py-1.5 flex items-center gap-1.5 ${e.status === "live" ? "bg-red-500 text-white" : "bg-plum-dark text-cream"}`, children: [
