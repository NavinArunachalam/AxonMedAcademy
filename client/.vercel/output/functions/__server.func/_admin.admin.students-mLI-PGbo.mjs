...
import { X as useClassroomStore, y as getClassrooms, w as getAdminUsers, f as classroomActions, k as createAdminUser, d as addStudentsToClassroom, J as messageActions } from "./_ssr/router-DF-WlXjF.mjs";
import { D as Download, a0 as Plus, aq as X, a8 as Search, ap as Video, P as Mail, p as ChevronUp, m as ChevronDown, u as ClipboardList } from "./_libs/lucide-react.mjs";
...
function AdminStudents() {
  ...
  const handleExport = () => {
    const csv = ["Name,Email,Courses,Batches,Progress,Attendance,Quiz Avg,Status,Watch Progress", ...filtered.map((e) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
          ...
          filtered.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(React__default.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: `border-t border-cream/10 hover:bg-cream/5 cursor-pointer ${expandedId === s.id ? "bg-cream/5" : ""}`, onClick: () => setExpandedId((prev) => prev === s.id ? null : s.id), children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-cream/60 font-mono", children: Array.from(new Set(s.courses.map((c) => c.enrollmentId).filter(Boolean))).join(" / ") || "Not enrolled" })
                ] })
              ] }) }),
            ...
            expandedId === s.id && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { className: "border-t border-cream/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 7, className: "px-4 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(StudentDetail, { studentId: s.id }) }) })
          ] }, s.id))
        ] })
      ] }) })
    ] })
