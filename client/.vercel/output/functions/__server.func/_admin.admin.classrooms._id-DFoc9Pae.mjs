...
import { i as useClassroomStore, c as classroomActions, f as formatDuration, u as uid } from "./_ssr/classroomStore-B40uasVO.mjs";
import { h as getClassroomById, d as createMeeting, n as uploadClassroomRecordingToCloudflare, e as createQuiz, p as publishQuiz, c as closeQuiz, f as deleteQuiz, g as getAdminUsers, a as addStudentsToClassroom, u as updateClassroomStudentStatus } from "./_ssr/api-GlGI6V_B.mjs";
import { L as Link } from "./_libs/tanstack__react-router.mjs";
import { c as Route } from "./_ssr/router-uzhfses4.mjs";
import { c as ArrowLeft, R as Megaphone, a8 as Send, ai as Trash2, a0 as Plus, a2 as Radio, C as Calendar, v as Clock, $ as Play, ap as Video, am as Upload, aq as X, g as BookOpen, x as EyeOff, E as Eye, u as ClipboardList, l as Check } from "./_libs/lucide-react.mjs";
...
function MeetingStatusBadge({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[10px] uppercase tracking-widest font-bold px-2 py-1 rounded ${cls}`, children: label });
}
const TABS = [{
  key: "announcements",
  label: "📢 Announcements"
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DarkCard, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-display font-bold text-sm text-cream mb-3 flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Megaphone, { className: "h-4 w-4 text-lime" }),
        " Post Announcement"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { value: text, onChange: (e) => setText(e.target.value), placeholder: "Type your announcement… (supports emoji 🎯)", rows: 3, className: "w-full bg-cream/5 border border-cream/10 rounded-xl px-4 py-3 text-cream text-sm outline-none focus:border-lime/50 resize-none" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: handlePost, disabled: !text.trim(), className: "inline-flex items-center gap-2 rounded-full bg-lime text-plum-dark px-5 py-2 text-sm font-bold disabled:opacity-40", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
      cls.announcements.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(DarkCard, { className: "text-center py-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Megaphone, { className: "h-8 w-8 text-cream/20 mx-auto mb-2" }),
      ...
      cls.announcements.map((ann) => /* @__PURE__ */ jsxRuntimeExports.jsx(DarkCard, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => classroomActions.deleteAnnouncement(classroomId, ann.id), className: "text-cream/30 hover:text-red-400 transition-colors shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "h-4 w-4" }) })
      ] }) }, ann.id))
    ] })
  ] });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
    ...
    upcoming.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: upcoming.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs(DarkCard, { className: "flex items-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid h-12 w-12 shrink-0 place-items-center rounded-xl bg-lime/10 text-lime", children: m.status === "live" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Radio, { className: "h-5 w-5 animate-pulse" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "h-5 w-5" }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 shrink-0", children: [
          m.status === "scheduled" && /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => classroomActions.startMeeting(classroomId, m.id), className: "rounded-full bg-lime text-plum-dark px-4 py-2 text-xs font-bold flex items-center gap-1", children: [
          ...
          m.status === "live" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => window.open(`https://meet.jit.si/HTA-${m.roomId}`, "_blank"), className: "rounded-full bg-red-500/20 text-red-300 px-4 py-2 text-xs font-bold flex items-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Radio, { className: "h-3 w-3" }),
              " Rejoin"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => classroomActions.endMeeting(classroomId, m.id), className: "rounded-full bg-cream/10 text-cream/70 px-3 py-2 text-xs", children: "End" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => classroomActions.deleteMeeting(classroomId, m.id), disabled: deletingMeetingId === m.id, className: "rounded-full bg-cream/5 text-cream/40 hover:text-red-400 p-2 text-xs disabled:opacity-50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "h-3.5 w-3.5" }) })
        ] })
      ] }, m.id)) })
    ] }),
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-red-400", children: error }),
    ...
    cls.meetings.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(DarkCard, { className: "text-center py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Video, { className: "h-8 w-8 text-cream/20 mx-auto mb-2" }),
...
function RecordingsTab({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleUpload, className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          form.chapters.map((ch, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 bg-cream/5 rounded-lg px-3 py-1.5 mb-1 text-xs text-cream/80", children: [
            ...
            })), className: "text-cream/40 hover:text-red-400", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-3 w-3" }) })
          ] }, ch.id))
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 pt-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => setShowForm(false), className: "flex-1 rounded-full bg-cream/10 text-cream py-2.5 text-sm font-semibold", children: "Cancel" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", disabled: uploading, className: "flex-1 rounded-full bg-lime text-plum-dark py-2.5 text-sm font-bold disabled:opacity-60", children: uploading ? "Uploading…" : "Save Recording" })
        ] }),
    ...
    cls.recordings.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(DarkCard, { className: "text-center py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "h-8 w-8 text-cream/20 mx-auto mb-2" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: cls.recordings.map((rec) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(DarkCard, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-14 rounded-lg bg-linear-to-br from-lime/20 to-lime/5 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "h-5 w-5 text-lime" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => classroomActions.publishRecording(classroomId, rec.id, !rec.isPublished), className: `rounded-full px-3 py-1.5 text-xs font-semibold flex items-center gap-1 ${rec.isPublished ? "bg-cream/10 text-cream/70" : "bg-lime/10 text-lime"}`, children: rec.isPublished ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => classroomActions.deleteRecording(classroomId, rec.id), className: "rounded-full bg-cream/5 text-cream/40 hover:text-red-400 p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "h-3.5 w-3.5" }) })
          ] })
        ] }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-cream/3 border border-cream/10 p-4 space-y-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-wrap", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 ml-auto", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onRemove, className: "text-cream/30 hover:text-red-400 ml-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "h-4 w-4" }) })
      ] })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      q.options.map((opt, oi) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-center gap-2 rounded-lg px-3 py-2 border transition-colors ${opt.isCorrect ? "border-lime/40 bg-lime/5" : "border-cream/10 bg-cream/2"}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => toggleCorrect(opt.label), className: `h-5 w-5 shrink-0 rounded-full grid place-items-center text-[10px] font-bold border transition-colors ${opt.isCorrect ? "bg-lime border-lime text-plum-dark" : "border-cream/30 text-cream/50"}`, children: opt.isCorrect ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-3 w-3" }) : opt.label }),
...
function TestsTab({
  ...
  if (showBuilder) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setShowBuilder(false), className: "text-cream/60 hover:text-cream", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { className: "h-5 w-5" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-cream text-xl", children: "Quiz Builder" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DarkCard, { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-4", children: [{
          ...
          key: "negativeMarking",
          label: "Negative marking (−0.25/wrong)"
        }, {
          key: "showLeaderboard",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setQuiz((q) => ({
        ...q,
        questions: [...q.questions, newQuestion(q.questions.length + 1)]
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-cream/60 text-xs", children: [
            submitted.length,
            " submissions · ",
            passRate,
            "% pass rate · ",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setShowBuilder(true), className: "inline-flex items-center gap-2 rounded-full bg-lime text-plum-dark px-5 py-2.5 text-sm font-bold", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "h-4 w-4" }),
      " Create Quiz"
    ] }) }),
    cls.quizzes.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(DarkCard, { className: "text-center py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ClipboardList, { className: "h-8 w-8 text-cream/20 mx-auto mb-2" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: cls.quizzes.map((q) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx(DarkCard, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3 flex-wrap", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setViewQuizId(q.id), className: "rounded-full bg-cream/10 text-cream px-3 py-1.5 text-xs font-semibold flex items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { className: "h-3 w-3" }),
            " Report"
          ] }),
          q.status === "draft" && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handlePublishQuiz(q.id), disabled: quizOperationQuizId === q.id, className: "rounded-full bg-lime/10 text-lime px-3 py-1.5 text-xs font-semibold disabled:cursor-not-allowed disabled:opacity-50", children: quizOperationQuizId === q.id ? "Publishing..." : "Publish" }),
          q.status === "published" && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handleCloseQuiz(q.id), disabled: quizOperationQuizId === q.id, className: "rounded-full bg-cream/10 text-cream/70 px-3 py-1.5 text-xs font-semibold disabled:cursor-not-allowed disabled:opacity-50", children: quizOperationQuizId === q.id ? "Closing..." : "Close" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handleDeleteQuiz(q.id), disabled: quizOperationQuizId === q.id, className: "rounded-full bg-cream/5 text-cream/40 hover:text-red-400 p-2 disabled:cursor-not-allowed disabled:opacity-50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "h-3.5 w-3.5" }) })
        ] })
      ] }) }, q.id);
    }) })
  ] });
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(DarkCard, { className: "p-0 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
        ...
        cls.students.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-t border-cream/10 hover:bg-cream/5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "pr-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: s.status, onChange: (e) => handleStatusChange(s.id, e.target.value), className: "bg-cream/5 border border-cream/10 rounded-lg px-2 py-1 text-cream/70 text-xs outline-none", children: [
...
function AdminClassroomDetail() {
  ...
  const [backendClassroom, setBackendClassroom] = reactExports.useState(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 text-cream", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/admin/classrooms", className: "text-cream/60 hover:text-cream mt-1 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { className: "h-5 w-5" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-wrap", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 flex-wrap bg-cream/5 rounded-2xl p-1.5", children: TABS.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setTab(t.key), className: `flex-1 text-xs sm:text-sm font-semibold rounded-xl px-3 py-2.5 transition-colors ${tab === t.key ? "bg-lime text-plum-dark" : "text-cream/70 hover:text-cream"}`, children: t.label }, t.key)) }),
    tab === "announcements" && /* @__PURE__ */ jsxRuntimeExports.jsx(AnnouncementsTab, { classroomId: classroom.id }),
    tab === "live" && /* @__PURE__ */ jsxRuntimeExports.jsx(LiveClassesTab, { classroomId: classroom.id }),
    tab === "recordings" && /* @__PURE__ */ jsxRuntimeExports.jsx(RecordingsTab, { classroomId: classroom.id }),
    tab === "tests" && /* @__PURE__ */ jsxRuntimeExports.jsx(TestsTab, { classroomId: classroom.id }),
    tab === "students" && /* @__PURE__ */ jsxRuntimeExports.jsx(StudentsTab, { classroomId: classroom.id })
  ] });
}
export {
