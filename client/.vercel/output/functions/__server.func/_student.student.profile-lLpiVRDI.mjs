...
import { C as Card } from "./_ssr/PortalShell-CojTJ1Gj.mjs";
import { ar as useClassroomStore, h as adminActions, am as updateMyProfile, aq as uploadProfileAvatar } from "./_ssr/router-Dlc6vLg3.mjs";
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 pt-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-lime bg-white/10 px-2 py-0.5 rounded border border-white/10", children: userId })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
