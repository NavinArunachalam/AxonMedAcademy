...
import { L as LuArrowLeft, k as LuMegaphone, s as LuVideo, d as LuCircleDot, e as LuClipboardList, r as LuUsers, q as LuUpload, t as LuX, o as LuSend, h as LuDownload, p as LuTrash2, m as LuPlus, n as LuRadio, b as LuCalendar, f as LuClock, l as LuPlay, g as LuCopy, a as LuBookOpen, j as LuEyeOff, i as LuEye, c as LuCheck } from "./_libs/react-icons.mjs";
import { D as DarkCard } from "./_ssr/PortalShell-Bf01m6ol.mjs";
import { d as Route$2, aj as useClassroomStore, I as getClassroomById, j as classroomActions, $ as markClassroomFresh, Y as isClassroomStale, W as getRecordingStreamUrl, z as formatDuration, ad as unpublishRecording, a2 as publishRecording, x as deleteRecording, V as getQuizReport, ah as uploadClassroomFileToCloudinary, q as createClassroomAnnouncement, u as deleteClassroomAnnouncement, r as createMeeting, a8 as startMeeting, y as endMeeting, v as deleteMeeting, a3 as reuseClassroomRecording, ai as uploadClassroomRecordingToCloudflare, ac as uid, ag as updateQuiz, s as createQuiz, a1 as publishQuiz, l as closeQuiz, w as deleteQuiz, C as getAdminUsers, g as addStudentsToClassroom, af as updateClassroomStudentStatus } from "./_ssr/router-XgXT3cUT.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DarkCard, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "file", ref: fileInputRef, onChange: (e) => setPdfFile(e.target.files?.[0] ?? null), accept: ".pdf", className: "hidden" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => fileInputRef.current?.click(), disabled: isPosting, className: "inline-flex items-center gap-2 text-xs font-bold text-cream/60 hover:text-lime transition-colors disabled:opacity-50", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(LuUpload, { className: "h-3.5 w-3.5" }),
            " ",
            pdfFile ? "Change PDF" : "Attach PDF"
          ] }),
          pdfFile && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 bg-lime/10 border border-lime/20 rounded-full px-3 py-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold text-lime truncate max-w-[120px]", children: pdfFile.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setPdfFile(null), disabled: isPosting, className: "text-lime/60 hover:text-lime", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LuX, { className: "h-3 w-3" }) })
          ] }),
          uploadProgress !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-bold text-lime animate-pulse", children: [
            "Uploading ",
            uploadProgress,
            "%..."
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: handlePost, disabled: !text.trim() || isPosting, className: "inline-flex items-center gap-2 rounded-full bg-lime text-plum-dark px-5 py-2 text-sm font-bold disabled:opacity-40", children: [
      ...
      cls.announcements.map((ann) => /* @__PURE__ */ jsxRuntimeExports.jsx(DarkCard, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 flex-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
            ...
            ann.attachments && ann.attachments.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 flex flex-wrap gap-2", children: ann.attachments.map((at, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: at.url, target: "_blank", rel: "noreferrer", download: at.name, className: "inline-flex items-center gap-2 bg-cream/5 border border-cream/10 rounded-lg px-3 py-2 text-xs font-semibold text-cream/70 hover:bg-cream/10 hover:text-lime transition-all", children: [
