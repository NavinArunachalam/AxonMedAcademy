...
import { ao as useClassroomStore, T as getPublicPrograms, D as getAssetUrl, i as api } from "./router-Mu5AAhdf.mjs";
import { B as BlogDetailModal } from "./BlogDetailModal-BNplTazM.mjs";
...
const API_BASE = (() => {
  const runtime = "https://oc-pro.onrender.com/api/v1";
