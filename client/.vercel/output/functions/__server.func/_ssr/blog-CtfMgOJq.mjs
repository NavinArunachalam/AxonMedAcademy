...
const POSTS = [{
  ...
  date: "May 18, 2026",
  read: "6 min",
  title: "What hospitals actually look for in a Staff Nurse hire",
  ...
  date: "Apr 28, 2026",
  read: "4 min",
  title: "From village clinic to ICU — Priya's 14-month journey",
  excerpt: "How a small-town student now leads a critical-care shift at Apollo."
}, {
  cat: "Career",
  date: "Apr 20, 2026",
  read: "7 min",
  title: "Salary benchmarks for paramedical roles in 2026",
  excerpt: "A city-by-city, role-by-role compensation breakdown."
}, {
  cat: "Clinical",
  date: "Apr 15, 2026",
  read: "9 min",
  title: "The radiologist's quick-reference for MRI protocols",
  excerpt: "Common protocols across abdomen, brain, and musculoskeletal imaging."
}, {
  cat: "Stories",
  date: "Apr 08, 2026",
  read: "5 min",
  title: "How three OT techs revolutionized their hospital's flow",
  excerpt: "A real-world case study of process improvement on the floor."
}];
function Blog() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PublicLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 lg:py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-5 lg:px-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3", children: rest.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "group rounded-3xl border border-border bg-card overflow-hidden hover:-translate-y-1 transition-all", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[16/10] bg-gradient-to-br from-plum-dark to-plum overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-noise opacity-30" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-4 left-4 rounded-full bg-cream/95 px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider text-plum-dark", children: p.cat })
      ] }),
