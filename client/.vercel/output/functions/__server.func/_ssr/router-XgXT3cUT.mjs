...
const appCss = "/assets/styles-DvgJj4wt.css";
...
const $$splitComponentImporter$B = () => import("./placements-bWM3ca7x.mjs");
const Route$B = createFileRoute("/placements")({
  component: lazyRouteComponent($$splitComponentImporter$B, "component")
});
const $$splitComponentImporter$A = () => import("./login-Cosmqnlm.mjs");
const Route$A = createFileRoute("/login")({
  component: lazyRouteComponent($$splitComponentImporter$A, "component")
});
const $$splitComponentImporter$z = () => import("./enroll-6fYMwtdR.mjs");
const Route$z = createFileRoute("/enroll")({
  component: lazyRouteComponent($$splitComponentImporter$z, "component")
});
const $$splitComponentImporter$y = () => import("./courses-BHw2r0hL.mjs");
const Route$y = createFileRoute("/courses")({
  component: lazyRouteComponent($$splitComponentImporter$y, "component")
});
const $$splitComponentImporter$x = () => import("./contact-KwQJM-OV.mjs");
const Route$x = createFileRoute("/contact")({
  component: lazyRouteComponent($$splitComponentImporter$x, "component")
});
const $$splitComponentImporter$w = () => import("./blog-DUL643f8.mjs");
const Route$w = createFileRoute("/blog")({
  component: lazyRouteComponent($$splitComponentImporter$w, "component")
});
const $$splitComponentImporter$v = () => import("./about-Bu3EHjNb.mjs");
const Route$v = createFileRoute("/about")({
  component: lazyRouteComponent($$splitComponentImporter$v, "component")
});
const $$splitComponentImporter$u = () => import("../_student-DChseZtz.mjs");
const Route$u = createFileRoute("/_student")({
  component: lazyRouteComponent($$splitComponentImporter$u, "component")
});
const $$splitComponentImporter$t = () => import("../_admin-DxeGtf0o.mjs");
const Route$t = createFileRoute("/_admin")({
  component: lazyRouteComponent($$splitComponentImporter$t, "component")
});
const $$splitComponentImporter$s = () => import("./index-DKC1zp4N.mjs");
const Route$s = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$s, "component")
});
const $$splitComponentImporter$r = () => import("./live._roomId-DkcQZi98.mjs");
const Route$r = createFileRoute("/live/$roomId")({
  component: lazyRouteComponent($$splitComponentImporter$r, "component")
});
const $$splitComponentImporter$q = () => import("../_student.student.schedule-CobYYjRm.mjs");
const Route$q = createFileRoute("/_student/student/schedule")({
  component: lazyRouteComponent($$splitComponentImporter$q, "component")
});
const $$splitComponentImporter$p = () => import("../_student.student.profile-CNm7Bdr_.mjs");
const Route$p = createFileRoute("/_student/student/profile")({
  component: lazyRouteComponent($$splitComponentImporter$p, "component")
});
const $$splitComponentImporter$o = () => import("../_student.student.messages-DysftI1K.mjs");
const Route$o = createFileRoute("/_student/student/messages")({
  component: lazyRouteComponent($$splitComponentImporter$o, "component")
});
const $$splitComponentImporter$n = () => import("../_student.student.live-BCV-uDxs.mjs");
const Route$n = createFileRoute("/_student/student/live")({
  component: lazyRouteComponent($$splitComponentImporter$n, "component")
});
const $$splitComponentImporter$m = () => import("../_student.student.exams-smSwR03c.mjs");
const Route$m = createFileRoute("/_student/student/exams")({
  component: lazyRouteComponent($$splitComponentImporter$m, "component")
});
const $$splitComponentImporter$l = () => import("../_student.student.dashboard-BwHnJ1MD.mjs");
const Route$l = createFileRoute("/_student/student/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$l, "component")
});
const $$splitComponentImporter$k = () => import("../_student.student.certificates-1qJgQybz.mjs");
const Route$k = createFileRoute("/_student/student/certificates")({
  component: lazyRouteComponent($$splitComponentImporter$k, "component")
});
const $$splitComponentImporter$j = () => import("../_admin.admin.students-B2CHKDeL.mjs");
const Route$j = createFileRoute("/_admin/admin/students")({
  component: lazyRouteComponent($$splitComponentImporter$j, "component")
});
const $$splitComponentImporter$i = () => import("../_admin.admin.settings-D7O2aN5W.mjs");
const Route$i = createFileRoute("/_admin/admin/settings")({
  component: lazyRouteComponent($$splitComponentImporter$i, "component")
});
const $$splitComponentImporter$h = () => import("../_admin.admin.placements-CXvRVNHt.mjs");
const Route$h = createFileRoute("/_admin/admin/placements")({
  component: lazyRouteComponent($$splitComponentImporter$h, "component")
});
const $$splitComponentImporter$g = () => import("../_admin.admin.messages-BZ6ysssl.mjs");
const Route$g = createFileRoute("/_admin/admin/messages")({
  component: lazyRouteComponent($$splitComponentImporter$g, "component")
});
const $$splitComponentImporter$f = () => import("../_admin.admin.finance-DHyL0sWh.mjs");
const Route$f = createFileRoute("/_admin/admin/finance")({
  component: lazyRouteComponent($$splitComponentImporter$f, "component")
});
const $$splitComponentImporter$e = () => import("../_admin.admin.faculty-DCXdK3Dp.mjs");
const Route$e = createFileRoute("/_admin/admin/faculty")({
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import("../_admin.admin.exams-t1Y-yu8O.mjs");
const Route$d = createFileRoute("/_admin/admin/exams")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("../_admin.admin.dashboard-D49KeA8s.mjs");
const Route$c = createFileRoute("/_admin/admin/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("../_admin.admin.courses-Lham_NOd.mjs");
const Route$b = createFileRoute("/_admin/admin/courses")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("../_admin.admin.analytics-CYjOhPuB.mjs");
const Route$a = createFileRoute("/_admin/admin/analytics")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("../_student.student.my-courses.index-DsH6ZZAJ.mjs");
const Route$9 = createFileRoute("/_student/student/my-courses/")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("../_student.student.classrooms.index-RfoUad-k.mjs");
const Route$8 = createFileRoute("/_student/student/classrooms/")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("../_admin.admin.classrooms.index-B9tbQzJv.mjs");
const Route$7 = createFileRoute("/_admin/admin/classrooms/")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("../_admin.admin.classes.index-Bt3KzaKd.mjs");
const Route$6 = createFileRoute("/_admin/admin/classes/")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("../_student.student.webex._roomId-Cdl6k6Hr.mjs");
const Route$5 = createFileRoute("/_student/student/webex/$roomId")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("../_student.student.course._id-Dr5nm2Ee.mjs");
const Route$4 = createFileRoute("/_student/student/course/$id")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("../_student.student.classroom._id-Dpwg4gC6.mjs");
const Route$3 = createFileRoute("/_student/student/classroom/$id")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("../_admin.admin.classrooms._id-D99LHs44.mjs");
const Route$2 = createFileRoute("/_admin/admin/classrooms/$id")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("../_admin.admin.classes._classId.students-5uuYJEbR.mjs");
const Route$1 = createFileRoute("/_admin/admin/classes/$classId/students")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("../_admin.admin.classes._classId.attendance-CLDZYGyX.mjs");
...
export {
  ...
  reuseClassroomRecording as a3,
  router as a4,
  saveAttendance as a5,
  saveQuizAnswer as a6,
  sendMessage as a7,
  startMeeting as a8,
  startQuizAttempt as a9,
  submitQuizAttempt as aa,
  trackRecordingProgress as ab,
  uid as ac,
  unpublishRecording as ad,
  updateAdminProgram as ae,
  updateClassroomStudentStatus as af,
  updateQuiz as ag,
  uploadClassroomFileToCloudinary as ah,
