...
import { a2 as logoutUser, k as classroomStore } from "./router-b9USinVv.mjs";
import { U as Menu, as as X, Q as LogOut } from "../_libs/lucide-react.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex-1 py-4 px-3 space-y-1 overflow-y-auto", children: [
      nav.map((item) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(item.icon, { className: "w-4.5 h-4.5 opacity-75 shrink-0" }),
              item.label
            ]
          },
          item.label
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(LogOut, { className: "w-4.5 h-4.5 shrink-0" }),
            "Sign Out"
          ]
        }
      )
