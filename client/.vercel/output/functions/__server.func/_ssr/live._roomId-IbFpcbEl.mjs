...
import { ar as useClassroomStore, R as Route$s, _ as heartbeatMeetingByRoomId, a0 as joinMeetingByRoomId, a1 as leaveMeetingByRoomId, i as api } from "./router-CFicUlxS.mjs";
