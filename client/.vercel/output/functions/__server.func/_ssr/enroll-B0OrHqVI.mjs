...
import { v as getAdminPrograms, M as registerStudent } from "./router-B1vgvhbB.mjs";
import { r as CircleCheck, ag as Stethoscope, M as LoaderCircle, d as ArrowRight } from "../_libs/lucide-react.mjs";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "mt-10 space-y-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-bold uppercase tracking-wider text-plum-dark/50", children: "First Name *" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { required: true, name: "firstName", value: formData.firstName, onChange: handleChange, type: "text", placeholder: "e.g. John", className: "w-full rounded-xl border border-border bg-card px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-plum/20 focus:border-plum transition-all" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-bold uppercase tracking-wider text-plum-dark/50", children: "Last Name *" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { required: true, name: "lastName", value: formData.lastName, onChange: handleChange, type: "text", placeholder: "e.g. Doe", className: "w-full rounded-xl border border-border bg-card px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-plum/20 focus:border-plum transition-all" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-bold uppercase tracking-wider text-plum-dark/50", children: "Create Password *" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { required: true, name: "password", value: formData.password, onChange: handleChange, type: "password", placeholder: "••••••••", className: "w-full rounded-xl border border-border bg-card px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-plum/20 focus:border-plum transition-all" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-foreground/40 italic", children: "This will be used for your student portal access once approved." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
