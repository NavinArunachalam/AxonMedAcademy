...
import { aj as useClassroomStore, E as getChatUsers, L as getConversation, k as classroomStore, a7 as sendMessage } from "./router-LScdOZhk.mjs";
import { T as MessageSquare, a6 as Search, a7 as Send } from "../_libs/lucide-react.mjs";
const SOCKET_URL = "https://oc-pro.onrender.com/api/v1".replace(/\/api\/v1$/, "");
