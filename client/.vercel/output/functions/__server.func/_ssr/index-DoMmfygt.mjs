      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-7", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.p,
          {
            ...
            children: "Join 5,000+ paramedical professionals who trained with Medicore and now build careers at India's leading hospitals. Live classes, proctored exams, blockchain certificates."
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
...
function CourseStrip() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-10 lg:py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto w-full max-w-[1400px] px-5 lg:px-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-5 sm:grid-cols-2 lg:grid-cols-3", children: courses.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group relative overflow-hidden rounded-3xl border border-border bg-card p-6 hover:border-plum-dark/30 hover:-translate-y-1 transition-all", children: [
...
function WhyUs() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-10 lg:py-16 bg-secondary/40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto w-full max-w-[1400px] px-5 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono uppercase tracking-[0.2em] text-plum", children: "— 02 / Why Medicore" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-3 font-display text-3xl lg:text-5xl font-bold text-plum-dark tracking-tight", children: [
...
function Faculty() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-10 lg:py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto w-full max-w-[1400px] px-5 lg:px-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-5 sm:grid-cols-2 lg:grid-cols-4", children: visible.map((f, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group rounded-3xl border border-border bg-card p-6 hover:-translate-y-1 hover:border-plum-dark/30 transition-all", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `relative h-44 rounded-2xl bg-gradient-to-br ${f.tint} overflow-hidden grid place-items-center`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-noise opacity-30" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative font-display text-5xl font-bold text-cream/90", children: f.initials }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-3 right-3 inline-flex items-center gap-1 rounded-full bg-cream/95 px-2 py-1 text-[11px] font-bold text-plum-dark", children: [
...
function BlogPreview() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-10 lg:py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto w-full max-w-[1400px] px-5 lg:px-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 lg:grid-cols-3", children: posts.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "group rounded-3xl overflow-hidden bg-card border border-border hover:-translate-y-1 transition-all", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `relative aspect-[16/10] bg-gradient-to-br ${p.tint} overflow-hidden`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-noise opacity-30" }),
