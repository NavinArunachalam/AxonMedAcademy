...
import { ad as Sparkles, d as ArrowRight, $ as Play, e as ArrowUpRight, I as HeartPulse, ag as Syringe, af as Stethoscope, z as FlaskConical, a4 as ScanLine, V as Microscope, v as Clock, ao as Users, ae as Star, ap as Video, ab as ShieldCheck, f as Award, h as Briefcase, w as CreditCard, t as ClipboardCheck, G as GraduationCap, a6 as ScrollText, n as ChevronLeft, o as ChevronRight, a1 as Quote, W as Minus, a0 as Plus, A as Activity, _ as Pill } from "../_libs/lucide-react.mjs";
...
function Hero() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", {
    className: "relative overflow-hidden pt-6 lg:pt-10 pb-12 lg:pb-16", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
      className: "mx-auto w-full max-w-[1400px] px-5 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "grid lg:grid-cols-12 gap-12 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.h1,
            {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", {
                  className: "relative inline-block", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("button", {
                className: "inline-flex items-center gap-2 rounded-full border border-plum-dark/15 bg-white/50 backdrop-blur px-6 py-3.5 text-sm font-semibold text-plum-dark hover:bg-white transition", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: stats$1.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                children: [
...
function HeroArt() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
    className: "relative aspect-[5/6] w-full max-w-md mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      className: "absolute inset-0 rounded-[40px] bg-gradient-to-br from-plum-dark via-plum to-plum-dark overflow-hidden shadow-2xl shadow-plum-dark/30", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("svg", {
        viewBox: "0 0 400 100", className: "absolute top-1/2 -translate-y-1/2 inset-x-0 w-full text-lime/60", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.path,
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
            className: "mt-3 h-1.5 w-full rounded-full bg-plum-dark/10 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
...
const courses = [
  { icon: HeartPulse, title: "Advanced Cardiac Care", duration: "6 Months", students: 1240, rating: 4.9, fee: 45e3, badge: "ICU", color: "from-plum to-plum-dark" },
  { icon: Syringe, title: "Staff Nursing Diploma", duration: "1 Year", students: 2100, rating: 4.8, fee: 68e3, badge: "Nursing", color: "from-plum-dark to-plum" },
  { icon: Stethoscope, title: "OT Technician Program", duration: "3 Months", students: 820, rating: 4.7, fee: 32e3, badge: "OT", color: "from-plum to-plum-dark" },
  { icon: FlaskConical, title: "Lab Technician (DMLT)", duration: "1 Year", students: 1530, rating: 4.8, fee: 54e3, badge: "Lab", color: "from-plum-dark to-plum" },
  { icon: ScanLine, title: "Radiology & Imaging", duration: "6 Months", students: 690, rating: 4.6, fee: 49e3, badge: "Radio", color: "from-plum to-plum-dark" },
  { icon: Microscope, title: "Clinical Pathology", duration: "3 Months", students: 540, rating: 4.7, fee: 28e3, badge: "Path", color: "from-plum-dark to-plum" }
];
function CourseStrip() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
    className: "py-10 lg:py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      className: "mx-auto w-full max-w-[1400px] px-5 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "flex items-end justify-between flex-wrap gap-6 mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", {
            className: "mt-3 font-display text-3xl lg:text-5xl font-bold text-plum-dark tracking-tight", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, {
          to: "/courses", className: "group inline-flex items-center gap-2 text-sm font-semibold text-plum-dark hover:gap-3 transition-all", children: [
            "View all 30+ courses",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className: "grid gap-5 sm:grid-cols-2 lg:grid-cols-3", children: courses.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "group relative overflow-hidden rounded-3xl border border-border bg-card p-6 hover:border-plum-dark/30 hover:-translate-y-1 transition-all", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `absolute -top-16 -right-16 h-44 w-44 rounded-full bg-gradient-to-br ${c.color} opacity-10 group-hover:opacity-20 transition-opacity` }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            className: "relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
              className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid h-12 w-12 place-items-center rounded-2xl bg-plum-dark text-lime", children: /* @__PURE__ */ jsxRuntimeExports.jsx(c.icon, { className: "h-5 w-5" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-full bg-secondary px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider text-plum-dark", children: c.badge })
              ]
            }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
              className: "mt-3 flex items-center gap-4 text-xs text-foreground/60", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
              className: "mt-6 flex items-center justify-between border-t border-border pt-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-foreground/50", children: "Starting at" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                  className: "font-display text-xl font-bold text-plum-dark", children: [
                    "₹",
...
function WhyUs() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
    className: "py-10 lg:py-16 bg-secondary/40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      className: "mx-auto w-full max-w-[1400px] px-5 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className: "mt-14 grid gap-px bg-border rounded-3xl overflow-hidden lg:grid-cols-3 sm:grid-cols-2", children: items$1.map((it) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "group bg-card p-8 hover:bg-plum-dark transition-colors duration-300", children: [
...
function PlacementBanner() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", {
    ref, className: "relative py-12 lg:py-20 overflow-hidden bg-plum-dark text-cream", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      className: "relative mx-auto w-full max-w-[1400px] px-5 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "max-w-2xl mb-14", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono uppercase tracking-[0.2em] text-lime", children: "— 03 / Outcomes" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", {
          className: "mt-3 font-display text-3xl lg:text-5xl font-bold tracking-tight", children: [
...
function StatCell({ v, suffix, l, active }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    className: "border-t border-cream/15 pt-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      className: "font-display text-5xl lg:text-6xl font-bold text-cream tracking-tight", children: [
...
function CrossPattern() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", {
    className: "absolute inset-0 w-full h-full opacity-[0.04]", "aria-hidden": true, children: [
...
const faculty = [
  ...
  { name: "Dr. Priya Iyer", role: "Chief Pathologist", specialty: "Lab Sciences", years: 22, rating: 5, initials: "PI", tint: "from-plum to-plum-dark" },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setIdx((i) => (i - 1 + faculty.length) % faculty.length), className: "grid h-11 w-11 place-items-center rounded-full border border-border hover:bg-plum-dark hover:text-cream hover:border-plum-dark transition", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { className: "h-4 w-4" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setIdx((i) => (i + 1) % faculty.length), className: "grid h-11 w-11 place-items-center rounded-full border border-border hover:bg-plum-dark hover:text-cream hover:border-plum-dark transition", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "h-4 w-4" }) })
          ]
        })
        ]
      }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className: "grid gap-5 sm:grid-cols-2 lg:grid-cols-4", children: visible.map((f, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "group rounded-3xl border border-border bg-card p-6 hover:-translate-y-1 hover:border-plum-dark/30 transition-all", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            className: `relative h-44 rounded-2xl bg-gradient-to-br ${f.tint} overflow-hidden grid place-items-center`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-noise opacity-30" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative font-display text-5xl font-bold text-cream/90", children: f.initials }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
              className: "absolute bottom-3 right-3 inline-flex items-center gap-1 rounded-full bg-cream/95 px-2 py-1 text-[11px] font-bold text-plum-dark", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", {
              className: "text-xs text-foreground/60", children: [
                f.years,
                "y"
              ]
            })
...
function Testimonials() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "flex items-center gap-3 rounded-full bg-card border border-border px-4 py-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className: "grid gap-6 lg:grid-cols-3", children: items.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: `relative rounded-3xl p-7 border ${i === 1 ? "bg-plum-dark text-cream border-plum-dark" : "bg-card border-border"}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Quote, { className: `h-8 w-8 ${i === 1 ? "text-lime" : "text-plum/40"}` }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", {
            className: `mt-5 text-base leading-relaxed ${i === 1 ? "text-cream/90" : "text-foreground/80"}`, children: [
              '"',
              t.text,
              '"'
            ]
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            className: "mt-8 flex items-center gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className: "mt-8 grid gap-5 sm:grid-cols-3", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", {
          className: "group relative aspect-video overflow-hidden rounded-2xl bg-gradient-to-br from-plum to-plum-dark", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-noise opacity-30" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            className: "absolute bottom-3 left-3 right-3 text-cream text-xs font-semibold", children: [
              "Watch student story #",
              i
            ]
          })
...
function Partners() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", {
    className: "py-8 lg:py-12 border-y border-border bg-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
      className: "mx-auto w-full max-w-[1400px] px-5 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
...
function LearningPath() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
    className: "py-10 lg:py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      className: "mx-auto w-full max-w-[1400px] px-5 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "max-w-2xl mx-auto text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "mt-16 relative", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
          className: "grid lg:grid-cols-5 gap-8 lg:gap-4", children: steps.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            className: "relative flex flex-col items-center text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
              className: `relative grid h-24 w-24 place-items-center rounded-3xl ${s.highlight ? "bg-lime text-plum-dark" : "bg-card border border-border text-plum-dark"}`, children: [
...
function BlogPreview() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, {
          to: "/blog", className: "group inline-flex items-center gap-2 text-sm font-semibold text-plum-dark", children: [
            "All articles",
        /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpRight, { className: "h-4 w-4 group-hover:rotate-45 transition-transform" })
          ]
        })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className: "grid gap-6 lg:grid-cols-3", children: posts.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", {
          className: "group rounded-3xl overflow-hidden bg-card border border-border hover:-translate-y-1 transition-all", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            className: `relative aspect-[16/10] bg-gradient-to-br ${p.tint} overflow-hidden`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-noise opacity-30" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-4 left-4 rounded-full bg-cream/95 px-3 py-1 text-[11px] font-bold uppercase tracking-wider text-plum-dark", children: p.cat })
            ]
          }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
              className: "mt-5 inline-flex items-center gap-2 text-sm font-semibold text-plum-dark group-hover:gap-3 transition-all", children: [
                "Read article ",
...
function FAQ() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
    className: "py-10 lg:py-16 bg-secondary/40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      className: "mx-auto max-w-3xl px-5 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className: "space-y-3", children: faqs.map((f, i) => {
          const isOpen = open === i;
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            className: `rounded-2xl border bg-card transition-colors ${isOpen ? "border-plum-dark" : "border-border"}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, {
              initial: false, children: isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
...
function CtaBlock() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
    className: "py-10 lg:py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
      className: "mx-auto w-full max-w-[1400px] px-5 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "relative overflow-hidden rounded-[40px] bg-plum-dark text-cream p-10 lg:p-20", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", {
            className: "mt-4 font-display text-4xl lg:text-6xl font-bold tracking-tight leading-[1.05]", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, {
              to: "/courses", className: "group inline-flex items-center gap-2 rounded-full bg-lime px-7 py-4 text-sm font-bold text-plum-dark hover:bg-cream transition", children: [
                "Reserve My Seat",
