...
import { am as useClassroomStore, E as getChatUsers, L as getConversation, k as classroomStore, aa as sendMessage } from "./router-7BnTJDC3.mjs";
import { U as MessageSquare, a6 as Search, a7 as Send } from "../_libs/lucide-react.mjs";
const SOCKET_URL = "http://localhost:5000/api/v1".replace(/\/api\/v1$/, "");
