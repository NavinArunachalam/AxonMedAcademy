...
import { ak as useClassroomStore, R as Route$r, i as api } from "./router-BIMX1eZo.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        !showVideo && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
          display: "flex",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
          ...
          !audioEnabled && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
            ...
            alignItems: "center",
            justifyContent: "center"
          }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "12", height: "12", viewBox: "0 0 24 24", fill: "none", stroke: "white", strokeWidth: "2.5", strokeLinecap: "round", strokeLinejoin: "round", children: [
...
function VideoGrid() {
  ...
  screenTracks.forEach((t) => {
    allTiles.push({
      ...
      // screen audio is usually part of the screen track itself
  ...
  cameraTracks.forEach((t) => {
    ...
    allTiles.push({
      ...
      // ← separate mic trackRef for AudioTrack
  ...
  if (isSpeakerView && total > 1) {
    const mainId = speakerSocketId && allTiles.find((t) => t.id === speakerSocketId) ? speakerSocketId : allTiles[0].id;
...
function LiveClassroomRoom() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "meeting-layout animate-in", children: [
    ...
    lkToken ? /* @__PURE__ */ jsxRuntimeExports.jsxs(W, { serverUrl: LK_SERVER_URL, token: lkToken, connect: true, audio: true, video: true, onDisconnected: handleEnd, style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(_MediaControllerSync, { audioEnabled, videoEnabled, isScreenSharing: isScreenSharingState, onSyncActions: (actions) => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ControlBar, { audioEnabled, videoEnabled, isScreenSharing: isScreenSharingState, onToggleAudio: () => lkActionsRef.current ? lkActionsRef.current.toggleAudio() : setAudioEnabled((p) => !p), onToggleVideo: () => lkActionsRef.current ? lkActionsRef.current.toggleVideo() : setVideoEnabled((p) => !p), onScreenShare: () => lkActionsRef.current ? lkActionsRef.current.toggleScreen() : setIsScreenSharingState((p) => !p), onRaiseHand: () => getSocket()?.emit("raise-hand", {
      roomId: getRoomId()
