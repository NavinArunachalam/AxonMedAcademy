...
import { Q as MapPin, Z as Phone, P as Mail, v as Clock, a8 as Send } from "../_libs/lucide-react.mjs";
...
function Contact() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PublicLayout, {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", {
      className: "relative py-20 lg:py-28 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", {
          className: "mt-3 max-w-3xl font-display text-4xl lg:text-7xl font-bold text-plum-dark tracking-[-0.03em] leading-[1.02]", children: [
            "Let's start your",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
      className: "pb-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "mx-auto max-w-7xl px-5 lg:px-8 grid lg:grid-cols-5 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
          className: "lg:col-span-2 space-y-4", children: [{
            icon: MapPin,
            t: "Visit us",
          ...
          }].map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            className: "rounded-2xl border border-border bg-card p-5 flex gap-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
            type: "submit", className: "mt-6 inline-flex items-center gap-2 rounded-full bg-plum-dark px-7 py-3.5 text-sm font-semibold text-cream hover:bg-plum transition", children: sent ? "Sent — we'll be in touch ✓" : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
              children: [
                "Send message ",
