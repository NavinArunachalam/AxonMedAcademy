...
import { i as api } from "./router-CFicUlxS.mjs";
import { V as Menu, au as X, M as Instagram, O as Linkedin, av as Youtube, T as MapPin, a1 as Phone, S as Mail } from "../_libs/lucide-react.mjs";
...
function normalizeOrganization(raw = {}) {
  return {
    ...defaultOrganization,
    ...Object.fromEntries(
      Object.entries(raw).filter(([, value]) => value !== void 0 && value !== null && value !== "")
    )
  };
}
function useOrganizationDetails() {
  const [organization, setOrganization] = reactExports.useState(defaultOrganization);
  reactExports.useEffect(() => {
    let mounted = true;
    api.get("/public/contact-details").then((res) => {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex h-16 w-full max-w-[1400px] items-center justify-between px-5 lg:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2 group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-12 w-12 place-items-center rounded-xl bg-plum-dark text-lime transition-transform ", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "../../logo.jpeg", className: "h-full w-full" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-[17px] font-bold tracking-tight text-plum-dark", children: organization.name })
          ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-12 lg:grid-cols-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-10 w-10 place-items-center rounded-full text-plum-dark", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/logo.jpeg", alt: organization.name, className: "h-full w-full rounded-full" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-lg font-bold text-cream", children: organization.name })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 text-sm leading-relaxed max-w-xs", children: organization.about }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-5 space-y-3 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: addressLines.map((line, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                line,
                index < addressLines.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("br", {})
              ] }, `${line}-${index}`)) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "h-4 w-4 mt-0.5 text-lime shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: organization.phone })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-4 w-4 mt-0.5 text-lime shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: `mailto:${organization.email}`, children: organization.email }) })
            ] })
          ] })
        ] })
      ] }),
...
export {
  PublicLayout as P,
  defaultOrganization as d,
  normalizeOrganization as n
};
