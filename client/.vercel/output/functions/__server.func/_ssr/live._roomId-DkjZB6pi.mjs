...
import { ap as useClassroomStore, R as Route$s, Z as heartbeatMeetingByRoomId, $ as joinMeetingByRoomId, a0 as leaveMeetingByRoomId, i as api } from "./router-C73_oHkz.mjs";
