...
import { ak as useClassroomStore, R as Route$r, i as api } from "./router-BvvC6MMt.mjs";
import { l as lookup } from "../_libs/socket.io-client.mjs";
import { W, u as ur, B as Bt, a as ae } from "../_libs/livekit__components-react.mjs";
...
const SOCKET_URL = "https://oc-pro.onrender.com";
let socket = null;
function getSocket() {
  return socket;
}
...
function VideoTile({ trackRef, name, isLocal, audioEnabled = true, videoEnabled = true, isScreenShare = false }) {
  const videoHolderRef = reactExports.useRef(null);
  const letter = name?.charAt(0)?.toUpperCase() || "?";
  const showVideo = trackRef && videoEnabled;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "video-tile", ref: videoHolderRef, style: { position: "relative", background: "#0F0820", borderRadius: "12px", overflow: "hidden", display: "flex", alignItems: "center", justifyContent: "center", height: "100%" }, children: [
    ...
    !isLocal && audioEnabled && trackRef && trackRef.participant && /* @__PURE__ */ jsxRuntimeExports.jsx(ae, { trackRef }),
    !showVideo && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", gap: "10px", width: "100%", height: "100%", justifyContent: "center", background: "linear-gradient(135deg, #0F0820 0%, #1A0D3A 100%)", position: "absolute", inset: 0 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: "64px", height: "64px", borderRadius: "50%", background: "linear-gradient(135deg, #7C3AED, #E879F9)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "24px", fontWeight: "700", color: "white", boxShadow: "0 0 20px rgba(124,58,237,0.5)", fontFamily: "Plus Jakarta Sans, sans-serif" }, children: letter }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "rgba(255,255,255,0.5)", fontSize: "12px", margin: 0 }, children: isLocal ? "Camera off" : "No video" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "absolute", bottom: "8px", left: "8px", right: "8px", display: "flex", alignItems: "center", justifyContent: "space-between", zIndex: 2 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "rgba(0,0,0,0.7)", backdropFilter: "blur(4px)", color: "#fff", fontSize: "12px", fontWeight: "600", padding: "3px 10px", borderRadius: "6px", maxWidth: "70%", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", fontFamily: "Plus Jakarta Sans, sans-serif" }, children: [
        name,
        isLocal ? " (You)" : ""
      ] }),
      !audioEnabled && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { background: "rgba(255,74,106,0.85)", borderRadius: "6px", width: "26px", height: "26px", display: "flex", alignItems: "center", justifyContent: "center" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "12", height: "12", viewBox: "0 0 24 24", fill: "none", stroke: "white", strokeWidth: "2.5", strokeLinecap: "round", strokeLinejoin: "round", children: [
    ...
    isScreenShare && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "absolute", top: "8px", left: "8px", background: "rgba(124,58,237,0.9)", color: "white", fontSize: "11px", fontWeight: "700", padding: "3px 8px", borderRadius: "5px", zIndex: 11 }, children: "Screen" })
  ] });
}
function VideoGrid() {
  ...
  if (isSpeakerView && total > 1) {
    const mainId = speakerSocketId && allTiles.find((t) => t.id === speakerSocketId) ? speakerSocketId : screenTracks.length > 0 ? allTiles[0].id : allTiles[0].id;
    const mainTile = allTiles.find((t) => t.id === mainId) || allTiles[0];
    const stripTiles = allTiles.filter((t) => t.id !== mainTile.id);
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, display: "flex", gap: "6px", padding: "8px", background: "#030108", overflow: "hidden", minHeight: 0, minWidth: 0 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1, minWidth: 0, minHeight: 0 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        VideoTile,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: "180px", display: "flex", flexDirection: "column", gap: "6px", overflowY: "auto" }, children: stripTiles.map((tile) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { height: "120px", flexShrink: 0 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        VideoTile,
        {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1, display: "grid", gap: "6px", padding: "8px", background: "#030108", overflow: "hidden", minHeight: 0, ...getGridStyle() }, children: allTiles.map((tile, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { minHeight: 0, ...total === 3 && i === 0 ? { gridColumn: "1 / -1" } : {} }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    VideoTile,
    {
      trackRef: tile.trackRef,
      name: tile.name,
...
function ControlBar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "control-bar", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "control-bar-inner", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { id: "btn-end", onClick: onEnd, className: "ctrl-btn danger", title: isStaff ? "End Class" : "Leave", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "meeting-layout animate-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "meeting-header", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "meeting-header-right", children: [
        ...
        isStaff && displayRoomId && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: copyLink, style: {
          display: "flex",
          alignItems: "center",
          gap: "6px",
          ...
          fontWeight: "600",
          flexShrink: 0
        }, children: linkCopied ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Copied!" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Share Link" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
          display: "flex",
          alignItems: "center",
          gap: "6px",
    ...
    lkToken ? /* @__PURE__ */ jsxRuntimeExports.jsxs(W, { serverUrl: LK_SERVER_URL, token: lkToken, connect: true, audio: audioEnabled, video: videoEnabled, screen: isScreenSharingState, onDisconnected: handleEnd, style: {
      display: "flex",
      flexDirection: "column",
      flex: 1,
      minHeight: 0
    }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "meeting-main animate-in", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ControlBar, { audioEnabled, videoEnabled, isScreenSharing: isScreenSharingState, onToggleAudio: () => setAudioEnabled((p) => !p), onToggleVideo: () => setVideoEnabled((p) => !p), onScreenShare: () => setIsScreenSharingState((p) => !p), onRaiseHand: () => getSocket()?.emit("raise-hand", {
        roomId: getRoomId()
