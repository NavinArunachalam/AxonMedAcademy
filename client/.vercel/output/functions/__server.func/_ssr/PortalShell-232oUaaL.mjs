...
import { S as Menu, aq as X } from "../_libs/lucide-react.mjs";
function PortalShell({ variant, brand, nav, user, children }) {
  ...
  const SidebarContent = () => /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex-1 py-4 px-3 space-y-1 overflow-y-auto", children: nav.map((item) => {
