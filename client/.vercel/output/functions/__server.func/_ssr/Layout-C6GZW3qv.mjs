...
import { af as Stethoscope, S as Menu, aq as X, K as Instagram, M as Linkedin, ar as Youtube, Q as MapPin, Z as Phone, P as Mail } from "../_libs/lucide-react.mjs";
const NAV = [
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 left-0 z-50 w-full transition-all duration-300 ${scrolled ? "bg-cream/65 backdrop-blur-md border-b border-border shadow-sm" : "bg-transparent"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "mx-auto flex h-16 w-full max-w-[1400px] items-center justify-between px-5 lg:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, {
          to: "/", className: "flex items-center gap-2 group", children: [
            ...
            className: "font-display text-[17px] font-bold tracking-tight text-plum-dark", children: [
              "Axon",
          ...
          className: "hidden lg:flex items-center gap-1", children: NAV.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: n.to,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "hidden lg:flex items-center gap-3", children: [
        ...
        open && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "fixed inset-0 z-[60] lg:hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            className: "absolute right-0 top-0 h-full w-[85%] max-w-sm bg-cream p-6 flex flex-col", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("nav", {
              className: "mt-8 flex flex-col gap-1", children: NAV.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Link,
                {
                  to: n.to,
                  onClick: () => setOpen(false),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
              className: "mt-auto flex flex-col gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Link,
                {
                  to: "/login",
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", {
    className: "mt-24 bg-plum-dark text-cream/85 relative overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      className: "relative mx-auto w-full max-w-[1400px] px-5 lg:px-8 py-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "grid gap-12 lg:grid-cols-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "lg:col-span-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, {
            to: "/", className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
            className: "mt-6 flex gap-2", children: [Instagram, Linkedin, Youtube].map((Icon, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: "#",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(FCol, {
          title: "Courses", links: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", {
            className: "mt-5 space-y-3 text-sm", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "hello@Axon.academy" })
              ]
            })
            ]
          })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "mt-14 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-t border-cream/15 pt-6 text-xs text-cream/60", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", {
          children: [
            "© ",
            (/* @__PURE__ */ new Date()).getFullYear(),
            " Axon Academy. All rights reserved."
          ]
        }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "flex gap-5", children: [
...
function PublicLayout({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    className: "min-h-screen flex flex-col bg-background text-foreground w-full", children: [
