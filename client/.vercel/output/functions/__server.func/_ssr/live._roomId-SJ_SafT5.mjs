...
import { am as useClassroomStore, R as Route$s, Y as heartbeatMeetingByRoomId, _ as joinMeetingByRoomId, $ as leaveMeetingByRoomId, i as api } from "./router-BgLlorBt.mjs";
