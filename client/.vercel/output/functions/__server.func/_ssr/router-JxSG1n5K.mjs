...
const $$splitComponentImporter$w = () => import("./placements-CuaCZkwK.mjs");
const Route$w = createFileRoute("/placements")({
  component: lazyRouteComponent($$splitComponentImporter$w, "component")
});
const $$splitComponentImporter$v = () => import("./login-BEaa2AMu.mjs");
const Route$v = createFileRoute("/login")({
  component: lazyRouteComponent($$splitComponentImporter$v, "component")
});
const $$splitComponentImporter$u = () => import("./faculty-BhwpNA6I.mjs");
const Route$u = createFileRoute("/faculty")({
  component: lazyRouteComponent($$splitComponentImporter$u, "component")
});
const $$splitComponentImporter$t = () => import("./courses-lyQMep6W.mjs");
const Route$t = createFileRoute("/courses")({
  component: lazyRouteComponent($$splitComponentImporter$t, "component")
});
const $$splitComponentImporter$s = () => import("./contact-cI2YNGHr.mjs");
const Route$s = createFileRoute("/contact")({
  component: lazyRouteComponent($$splitComponentImporter$s, "component")
});
const $$splitComponentImporter$r = () => import("./blog-t0X0Siqw.mjs");
const Route$r = createFileRoute("/blog")({
  component: lazyRouteComponent($$splitComponentImporter$r, "component")
});
const $$splitComponentImporter$q = () => import("./about-D1ExODMB.mjs");
const Route$q = createFileRoute("/about")({
  component: lazyRouteComponent($$splitComponentImporter$q, "component")
});
const $$splitComponentImporter$p = () => import("../_student-CTxzIqQ2.mjs");
const Route$p = createFileRoute("/_student")({
  component: lazyRouteComponent($$splitComponentImporter$p, "component")
});
const $$splitComponentImporter$o = () => import("../_admin-NgasDWR3.mjs");
const Route$o = createFileRoute("/_admin")({
  component: lazyRouteComponent($$splitComponentImporter$o, "component")
});
const $$splitComponentImporter$n = () => import("./index-DoMmfygt.mjs");
...
const $$splitComponentImporter$e = () => import("../_admin.admin.settings-D0WCLauB.mjs");
...
const $$splitComponentImporter$3 = () => import("../_student.student.jitsi._roomId-DdYPQOTc.mjs");
const Route$3 = createFileRoute("/_student/student/jitsi/$roomId")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("../_student.student.course._id-BATiGPw0.mjs");
const Route$2 = createFileRoute("/_student/student/course/$id")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("../_student.student.classroom._id-vKCsTswn.mjs");
const Route$1 = createFileRoute("/_student/student/classroom/$id")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("../_admin.admin.classrooms._id-C5njSjrZ.mjs");
