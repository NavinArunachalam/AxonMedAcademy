...
import { b as classroomStore } from "./classroomStore-B40uasVO.mjs";
import { m as loginUser } from "./api-GlGI6V_B.mjs";
import { af as Stethoscope, d as ArrowRight } from "../_libs/lucide-react.mjs";
...
function Login() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      className: "hidden lg:flex w-1/2 relative bg-plum-dark text-cream p-12 flex-col justify-between overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, {
        to: "/", className: "relative inline-flex items-center gap-2 w-fit", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", {
          className: "font-display text-4xl lg:text-5xl font-bold leading-[1.05] tracking-[-0.02em]", children: [
            "Welcome back.",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "relative text-xs text-cream/50", children: [
          "© ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
      className: "flex-1 grid place-items-center p-6 lg:p-12 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "w-full max-w-md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, {
          to: "/", className: "lg:hidden inline-flex items-center gap-2 mb-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", {
          onSubmit: handleLogin, className: "mt-8 space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
              children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                className: "flex justify-between items-center mb-1.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", {
              type: "submit", disabled: isSubmitting, className: "group w-full inline-flex items-center justify-center gap-2 rounded-full bg-plum-dark px-6 py-3.5 text-sm font-semibold text-cream hover:bg-plum transition disabled:cursor-not-allowed disabled:opacity-70", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "my-6 flex items-center gap-3 text-xs text-foreground/50", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "mt-6 rounded-2xl border border-dashed border-plum/30 bg-secondary/60 p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-widest text-plum font-bold", children: "Demo Accounts" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            className: "mt-2 text-xs text-foreground/60 space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Admin: ID `Admin`, Pass `axon@admin`" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Student 1: ID `Ajay`, Pass `1111`" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Student 2: ID `Navin`, Pass `2222`" })
            ]
          })
          ]
        }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", {
          className: "mt-6 text-center text-sm text-foreground/65", children: [
            "New to Axon? ",
