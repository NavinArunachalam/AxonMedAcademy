...
const appCss = "/assets/styles-Ch5ZUsln.css";
...
const $$splitComponentImporter$x = () => import("./placements-8wBM7Dx1.mjs");
const Route$x = createFileRoute("/placements")({
  component: lazyRouteComponent($$splitComponentImporter$x, "component")
});
const $$splitComponentImporter$w = () => import("./login-CB7EYX8E.mjs");
const Route$w = createFileRoute("/login")({
  component: lazyRouteComponent($$splitComponentImporter$w, "component")
});
const $$splitComponentImporter$v = () => import("./faculty-Cml6D0_q.mjs");
const Route$v = createFileRoute("/faculty")({
  component: lazyRouteComponent($$splitComponentImporter$v, "component")
});
const $$splitComponentImporter$u = () => import("./enroll-CDwiPM1N.mjs");
const Route$u = createFileRoute("/enroll")({
  component: lazyRouteComponent($$splitComponentImporter$u, "component")
});
const $$splitComponentImporter$t = () => import("./courses-l7hBi3xu.mjs");
const Route$t = createFileRoute("/courses")({
  component: lazyRouteComponent($$splitComponentImporter$t, "component")
});
const $$splitComponentImporter$s = () => import("./contact-Dc8uSaxm.mjs");
const Route$s = createFileRoute("/contact")({
  component: lazyRouteComponent($$splitComponentImporter$s, "component")
});
const $$splitComponentImporter$r = () => import("./blog-CaJqTPf_.mjs");
const Route$r = createFileRoute("/blog")({
  component: lazyRouteComponent($$splitComponentImporter$r, "component")
});
const $$splitComponentImporter$q = () => import("./about-hXuI0rfc.mjs");
const Route$q = createFileRoute("/about")({
  component: lazyRouteComponent($$splitComponentImporter$q, "component")
});
const $$splitComponentImporter$p = () => import("../_student-DDdYjgqx.mjs");
const Route$p = createFileRoute("/_student")({
  component: lazyRouteComponent($$splitComponentImporter$p, "component")
});
const $$splitComponentImporter$o = () => import("../_admin-DNfY5_QF.mjs");
const Route$o = createFileRoute("/_admin")({
  component: lazyRouteComponent($$splitComponentImporter$o, "component")
});
const $$splitComponentImporter$n = () => import("./index-C4ZGUnqB.mjs");
const Route$n = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$n, "component")
});
const $$splitComponentImporter$m = () => import("../_student.student.schedule-CaiFaJjh.mjs");
const Route$m = createFileRoute("/_student/student/schedule")({
  component: lazyRouteComponent($$splitComponentImporter$m, "component")
});
const $$splitComponentImporter$l = () => import("../_student.student.profile-thpy0tiD.mjs");
const Route$l = createFileRoute("/_student/student/profile")({
  component: lazyRouteComponent($$splitComponentImporter$l, "component")
});
const $$splitComponentImporter$k = () => import("../_student.student.messages-CjKPXfck.mjs");
const Route$k = createFileRoute("/_student/student/messages")({
  component: lazyRouteComponent($$splitComponentImporter$k, "component")
});
const $$splitComponentImporter$j = () => import("../_student.student.live-B2J016Zr.mjs");
const Route$j = createFileRoute("/_student/student/live")({
  component: lazyRouteComponent($$splitComponentImporter$j, "component")
});
const $$splitComponentImporter$i = () => import("../_student.student.exams-D8pcHPMT.mjs");
const Route$i = createFileRoute("/_student/student/exams")({
  component: lazyRouteComponent($$splitComponentImporter$i, "component")
});
const $$splitComponentImporter$h = () => import("../_student.student.dashboard-CgT2EA6e.mjs");
const Route$h = createFileRoute("/_student/student/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$h, "component")
});
const $$splitComponentImporter$g = () => import("../_student.student.certificates-ZG9Ao9bK.mjs");
const Route$g = createFileRoute("/_student/student/certificates")({
  component: lazyRouteComponent($$splitComponentImporter$g, "component")
});
const $$splitComponentImporter$f = () => import("../_admin.admin.students-DweNGYHb.mjs");
const Route$f = createFileRoute("/_admin/admin/students")({
  component: lazyRouteComponent($$splitComponentImporter$f, "component")
});
const $$splitComponentImporter$e = () => import("../_admin.admin.settings-DfERaVc3.mjs");
const Route$e = createFileRoute("/_admin/admin/settings")({
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import("../_admin.admin.placements-BfBCCydw.mjs");
const Route$d = createFileRoute("/_admin/admin/placements")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("../_admin.admin.finance-D8QpmQq2.mjs");
const Route$c = createFileRoute("/_admin/admin/finance")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("../_admin.admin.faculty-ZnjuephU.mjs");
const Route$b = createFileRoute("/_admin/admin/faculty")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("../_admin.admin.exams-DYsD8l_j.mjs");
const Route$a = createFileRoute("/_admin/admin/exams")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("../_admin.admin.dashboard-EEaieWRi.mjs");
const Route$9 = createFileRoute("/_admin/admin/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("../_admin.admin.courses-Dp4OpNlt.mjs");
const Route$8 = createFileRoute("/_admin/admin/courses")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("../_admin.admin.analytics-DXQRPK6D.mjs");
const Route$7 = createFileRoute("/_admin/admin/analytics")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("../_student.student.my-courses.index-CWpgycc_.mjs");
const Route$6 = createFileRoute("/_student/student/my-courses/")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("../_student.student.classrooms.index-DbA7KLVn.mjs");
const Route$5 = createFileRoute("/_student/student/classrooms/")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("../_admin.admin.classrooms.index-BeRDIk3d.mjs");
const Route$4 = createFileRoute("/_admin/admin/classrooms/")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("../_student.student.webex._roomId-CiyuOg5Z.mjs");
const Route$3 = createFileRoute("/_student/student/webex/$roomId")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("../_student.student.course._id-fqF7HOvk.mjs");
const Route$2 = createFileRoute("/_student/student/course/$id")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("../_student.student.classroom._id-DdHCqLHK.mjs");
const Route$1 = createFileRoute("/_student/student/classroom/$id")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("../_admin.admin.classrooms._id-Dt2Rv_z6.mjs");
...
export {
  router as $,
  getAssetUrl as A,
  getClassroomById as B,
  getClassrooms as C,
  getDetailedProgress as D,
  getExamType as E,
  getGrade as F,
  getMeetingByRoomId as G,
  getMyClassrooms as H,
  getMyMeetings as I,
  getMyNotifications as J,
  getPublicPrograms as K,
  getQuizAttemptResult as L,
  getQuizReport as M,
  getRecordingStreamUrl as N,
  heartbeatMeetingByRoomId as O,
  isClassroomStale as P,
  joinMeetingByRoomId as Q,
  Route$3 as R,
  leaveMeetingByRoomId as S,
  loginUser as T,
  logoutUser as U,
  markClassroomFresh as V,
  messageActions as W,
  publishQuiz as X,
  publishRecording as Y,
  registerStudent as Z,
  reuseClassroomRecording as _,
  Route$2 as a,
  saveQuizAnswer as a0,
  startMeeting as a1,
  startQuizAttempt as a2,
  submitQuizAttempt as a3,
  trackRecordingProgress as a4,
  uid as a5,
  unpublishRecording as a6,
  updateAdminProgram as a7,
  updateClassroomStudentStatus as a8,
  updateQuiz as a9,
  uploadClassroomRecordingToCloudflare as aa,
  useClassroomStore as ab,
  Route$1 as b,
  Route as c,
  addStudentsToClassroom as d,
  adminActions as e,
  api as f,
  classroomActions as g,
  classroomStore as h,
  closeQuiz as i,
  computeCertificates as j,
  createAdminProgram as k,
  createAdminUser as l,
  createClassroom as m,
  createClassroomAnnouncement as n,
  createMeeting as o,
  createQuiz as p,
  deleteAdminProgram as q,
  deleteClassroomAnnouncement as r,
  deleteMeeting as s,
  deleteQuiz as t,
  deleteRecording as u,
  endMeeting as v,
  formatDuration as w,
  formatTime as x,
  getAdminPrograms as y,
  getAdminUsers as z
};
