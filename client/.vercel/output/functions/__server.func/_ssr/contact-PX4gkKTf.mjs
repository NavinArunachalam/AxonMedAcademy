...
import { d as defaultOrganization, P as PublicLayout, n as normalizeOrganization } from "./Layout-Ds2ClE8w.mjs";
...
import { T as MapPin, a1 as Phone, S as Mail, y as Clock, ac as Send } from "../_libs/lucide-react.mjs";
...
function Contact() {
  ...
  const [contactInfo, setContactInfo] = reactExports.useState(defaultOrganization);
  ...
  const handleSubmit = async (e) => {
    ...
    setErrorMsg("");
    try {
      const result = await submitToGoogleSheet("Contact Inquiries", {
