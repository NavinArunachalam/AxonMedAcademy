...
import { am as useClassroomStore, R as Route$s, Y as heartbeatMeetingByRoomId, _ as joinMeetingByRoomId, $ as leaveMeetingByRoomId, i as api } from "./router-xpcFlHIj.mjs";
...
function VideoGrid() {
  ...
  const activeFocusedId = focusedTileId !== null && allTiles.some((t) => t.id === focusedTileId) ? focusedTileId : defaultFocusedId;
  if (isMobile && total > 1) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
        ...
        overflowY: "auto",
        pointerEvents: "auto"
      }, children: floatingTiles.map((tile) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          onClick: (e) => {
            e.stopPropagation();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1, display: "grid", gap: "6px", padding: "8px", background: "#030108", overflow: "hidden", minHeight: 0, ...getGridStyle(), position: "relative" }, children: allTiles.map((tile, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      style: {
        minHeight: 0,
