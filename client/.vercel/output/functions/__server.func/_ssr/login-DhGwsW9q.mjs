...
import { a2 as loginUser, l as classroomStore } from "./router-CFicUlxS.mjs";
import "../_libs/firebase.mjs";
import "../_libs/firebase__messaging.mjs";
import { ak as Stethoscope, e as ArrowRight } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden lg:flex w-1/2 relative bg-plum-dark text-cream p-12 flex-col justify-between overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "relative inline-flex items-center gap-2 w-fit", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-lg font-bold", children: "Axon Med Academy" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 grid place-items-center p-6 lg:p-12 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleLogin, className: "mt-8 space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-semibold text-plum-dark mb-1.5", children: "User ID/Email" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: userId, onChange: (e) => setUserId(e.target.value), type: "text", placeholder: "e.g. example@gmail.com or Admin", className: "w-full rounded-full border border-border bg-card px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-plum", required: true })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
