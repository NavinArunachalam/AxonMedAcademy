...
import { ao as useClassroomStore, R as Route$s, Y as heartbeatMeetingByRoomId, _ as joinMeetingByRoomId, $ as leaveMeetingByRoomId, i as api } from "./router-Mu5AAhdf.mjs";
