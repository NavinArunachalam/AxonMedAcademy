...
import { ar as useClassroomStore, G as getChatUsers, N as getConversation, l as classroomStore, ac as sendMessage } from "./router-Dlc6vLg3.mjs";
import { X as MessageSquare, ab as Search, ac as Send } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl bg-white border border-border overflow-hidden h-[calc(100vh-80px)] flex flex-col md:flex-row", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "border-r border-border flex flex-col w-full md:w-[320px] shrink-0 bg-slate-50/50", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border-b border-border bg-white", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-plum-dark text-lg", children: isStudent ? "Faculty & Admin" : isFaculty ? "All Users" : "All Users" }),
          ...
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative shrink-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid h-11 w-11 place-items-center rounded-full bg-plum-dark text-lime text-xs font-bold", children: getInitials(user.fullName) }),
                unreadCounts[user._id] > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-1 -right-1 grid h-5 w-5 place-items-center rounded-full bg-red-500 text-[10px] font-bold text-white border-2 border-white shadow-sm", children: unreadCounts[user._id] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-w-0 pt-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-baseline gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm font-semibold text-plum-dark truncate", children: [
                  user.fullName,
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] text-slate-400 truncate", children: [
                    "(",
                    user.role,
                    ")"
                  ] })
        ...
        sortedMessages.map((m, i, arr) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex ${isMe ? "justify-end" : "justify-start"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: `max-w-[75%] rounded-2xl px-5 py-3 text-sm shadow-sm leading-relaxed ${isMe ? "bg-plum-dark text-cream rounded-br-sm" : "bg-cream/80 border border-slate-200 text-slate-700 rounded-bl-sm"}`,
                children: m.message
              }
            ) })
          ] }, m._id);
