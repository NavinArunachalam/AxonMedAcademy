...
import { a as getToken, o as onMessage, g as getMessagingInWindow } from "../_libs/firebase__messaging.mjs";
import { b as getApps, i as initializeApp } from "../_libs/firebase__app.mjs";
...
const getApiBase = () => {
  const runtimeApiUrl = "https://oc-pro-production.up.railway.app/api/v1";
...
async function uploadProfileAvatar(file, onProgress) {
  const accessToken = classroomStore.getState().accessToken;
...
async function generateQuizFromPdf(file) {
  ...
  const response = await fetch(`${API_BASE}/quizzes/generate-from-pdf`, {
    ...
    credentials: "include",
    headers,
    // Content-Type is omitted so browser sets it with multipart boundary
    body: formData
  });
  const payload = await response.json().catch(() => ({}));
  if (!response.ok) {
...
const firebaseConfig = {
  apiKey: "AIzaSyAomYecxM8cYkIITet1v8190s5sxNn_V5k",
  authDomain: "axonmedacademy-1bc61.firebaseapp.com",
  projectId: "axonmedacademy-1bc61",
  storageBucket: "axonmedacademy-1bc61.firebasestorage.app",
  messagingSenderId: "260745496890",
  appId: "1:260745496890:web:3d0b4eb047e37db8daa803"
};
const VAPID_KEY = "BKDpDEV2zoLAS36RI39YFBE39lxTxlF4_RDIDcDN07mKdSx_PX8gxwPkNf1EKjGrCmkvFCXctbGRyuck6mhllsA";
let _app = null;
let _messaging = null;
...
const appCss = "/assets/styles-BinCpmmt.css";
...
function RootComponent() {
  ...
  const [showPermissionPrompt, setShowPermissionPrompt] = reactExports.useState(false);
    ...
    Promise.all([
      ...
      if (role === "student") {
        if ("Notification" in window && Notification.permission === "default") {
          ...
          initFCM().catch(
            (err) => console.warn("[FCM] Background init failed:", err)
          );
        }
      }
    }).catch(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(QueryClientProvider, { client: queryClient, children: [
    ...
    showPermissionPrompt && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-[9999] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in duration-200", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-6 max-w-md w-full shadow-2xl relative overflow-hidden transform animate-in zoom-in-95 duration-200", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-12 w-12 rounded-2xl bg-purple-50 dark:bg-purple-950/40 text-purple-600 dark:text-purple-400 flex items-center justify-center mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.5", strokeLinecap: "round", strokeLinejoin: "round", className: "lucide lucide-bell animate-bounce", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-plum-dark dark:text-zinc-100 text-xl", children: "Enable Notifications" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-purple-600 dark:text-purple-400 mt-1", children: "Allow for live class updates" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-zinc-600 dark:text-zinc-400 mt-2", children: "Stay in the loop! Get instant alerts on your device the moment a live class is scheduled or started by your instructors." }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: async () => {
              ...
              sessionStorage.setItem("fcm_prompt_dismissed", "true");
              await initFCM().catch(
                (err) => console.warn("[FCM] Manual init failed:", err)
              );
            },
...
const $$splitComponentImporter$D = () => import("./placements-BCz0L78b.mjs");
const Route$D = createFileRoute("/placements")({
  component: lazyRouteComponent($$splitComponentImporter$D, "component")
});
const $$splitComponentImporter$C = () => import("./login-CnHiNlaQ.mjs");
const Route$C = createFileRoute("/login")({
  component: lazyRouteComponent($$splitComponentImporter$C, "component")
});
const $$splitComponentImporter$B = () => import("./faculty-0BqfKXK8.mjs");
const Route$B = createFileRoute("/faculty")({
  component: lazyRouteComponent($$splitComponentImporter$B, "component")
});
const $$splitComponentImporter$A = () => import("./enroll-CWpo_FSj.mjs");
const Route$A = createFileRoute("/enroll")({
  component: lazyRouteComponent($$splitComponentImporter$A, "component")
});
const $$splitComponentImporter$z = () => import("./courses-C4lJllRQ.mjs");
const Route$z = createFileRoute("/courses")({
  component: lazyRouteComponent($$splitComponentImporter$z, "component")
});
const $$splitComponentImporter$y = () => import("./contact-CGRyiSv_.mjs");
const Route$y = createFileRoute("/contact")({
  component: lazyRouteComponent($$splitComponentImporter$y, "component")
});
const $$splitComponentImporter$x = () => import("./blog-GHMF8-OG.mjs");
const Route$x = createFileRoute("/blog")({
  component: lazyRouteComponent($$splitComponentImporter$x, "component")
});
const $$splitComponentImporter$w = () => import("./about-BxKXSThc.mjs");
const Route$w = createFileRoute("/about")({
  component: lazyRouteComponent($$splitComponentImporter$w, "component")
});
const $$splitComponentImporter$v = () => import("../_student-QfWDqwhO.mjs");
const Route$v = createFileRoute("/_student")({
  component: lazyRouteComponent($$splitComponentImporter$v, "component")
});
const $$splitComponentImporter$u = () => import("../_admin-C51AxMNY.mjs");
const Route$u = createFileRoute("/_admin")({
  component: lazyRouteComponent($$splitComponentImporter$u, "component")
});
const $$splitComponentImporter$t = () => import("./index-CnRDTHN-.mjs");
const Route$t = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$t, "component")
});
const $$splitComponentImporter$s = () => import("./live._roomId-D1rV95b5.mjs");
const Route$s = createFileRoute("/live/$roomId")({
  component: lazyRouteComponent($$splitComponentImporter$s, "component")
});
const $$splitComponentImporter$r = () => import("../_student.student.schedule-D-QzUx4y.mjs");
const Route$r = createFileRoute("/_student/student/schedule")({
  component: lazyRouteComponent($$splitComponentImporter$r, "component")
});
const $$splitComponentImporter$q = () => import("../_student.student.profile-lLpiVRDI.mjs");
const Route$q = createFileRoute("/_student/student/profile")({
  component: lazyRouteComponent($$splitComponentImporter$q, "component")
});
const $$splitComponentImporter$p = () => import("../_student.student.messages-BkUl80Ix.mjs");
const Route$p = createFileRoute("/_student/student/messages")({
  component: lazyRouteComponent($$splitComponentImporter$p, "component")
});
const $$splitComponentImporter$o = () => import("../_student.student.live-gI7DaQIp.mjs");
const Route$o = createFileRoute("/_student/student/live")({
  component: lazyRouteComponent($$splitComponentImporter$o, "component")
});
const $$splitComponentImporter$n = () => import("../_student.student.exams-L22oeOr5.mjs");
const Route$n = createFileRoute("/_student/student/exams")({
  component: lazyRouteComponent($$splitComponentImporter$n, "component")
});
const $$splitComponentImporter$m = () => import("../_student.student.dashboard-QqNRk3gs.mjs");
const Route$m = createFileRoute("/_student/student/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$m, "component")
});
const $$splitComponentImporter$l = () => import("../_student.student.certificates-BJ0YY_r_.mjs");
const Route$l = createFileRoute("/_student/student/certificates")({
  component: lazyRouteComponent($$splitComponentImporter$l, "component")
});
const $$splitComponentImporter$k = () => import("../_admin.admin.students-BQw2lD4x.mjs");
const Route$k = createFileRoute("/_admin/admin/students")({
  component: lazyRouteComponent($$splitComponentImporter$k, "component")
});
const $$splitComponentImporter$j = () => import("../_admin.admin.settings-BoZj7nxT.mjs");
const Route$j = createFileRoute("/_admin/admin/settings")({
  component: lazyRouteComponent($$splitComponentImporter$j, "component")
});
const $$splitComponentImporter$i = () => import("../_admin.admin.placements-BdRrkUT6.mjs");
const Route$i = createFileRoute("/_admin/admin/placements")({
  component: lazyRouteComponent($$splitComponentImporter$i, "component")
});
const $$splitComponentImporter$h = () => import("../_admin.admin.messages-CUiudEKx.mjs");
const Route$h = createFileRoute("/_admin/admin/messages")({
  component: lazyRouteComponent($$splitComponentImporter$h, "component")
});
const $$splitComponentImporter$g = () => import("../_admin.admin.finance-Brt9I5yB.mjs");
const Route$g = createFileRoute("/_admin/admin/finance")({
  component: lazyRouteComponent($$splitComponentImporter$g, "component")
});
const $$splitComponentImporter$f = () => import("../_admin.admin.faculty-Dq2_qfmA.mjs");
const Route$f = createFileRoute("/_admin/admin/faculty")({
  component: lazyRouteComponent($$splitComponentImporter$f, "component")
});
const $$splitComponentImporter$e = () => import("../_admin.admin.exams-Cvxj6wNr.mjs");
const Route$e = createFileRoute("/_admin/admin/exams")({
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import("../_admin.admin.dashboard-DIBf3x8m.mjs");
const Route$d = createFileRoute("/_admin/admin/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("../_admin.admin.courses-DqWkDFZM.mjs");
const Route$c = createFileRoute("/_admin/admin/courses")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("../_admin.admin.certificates-D4Am01uR.mjs");
const Route$b = createFileRoute("/_admin/admin/certificates")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("../_admin.admin.analytics-DILHdiED.mjs");
const Route$a = createFileRoute("/_admin/admin/analytics")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("../_student.student.my-courses.index-DrFj4oHi.mjs");
const Route$9 = createFileRoute("/_student/student/my-courses/")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("../_student.student.classrooms.index-BfSZrg-h.mjs");
const Route$8 = createFileRoute("/_student/student/classrooms/")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("../_admin.admin.classrooms.index-Bc3BRnlM.mjs");
const Route$7 = createFileRoute("/_admin/admin/classrooms/")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("../_admin.admin.classes.index-D6_8KnkF.mjs");
const Route$6 = createFileRoute("/_admin/admin/classes/")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("../_student.student.webex._roomId-Bxtog5al.mjs");
const Route$5 = createFileRoute("/_student/student/webex/$roomId")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("../_student.student.course._id-88GwSe8w.mjs");
const Route$4 = createFileRoute("/_student/student/course/$id")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("../_student.student.classroom._id-Clj_t8-r.mjs");
const Route$3 = createFileRoute("/_student/student/classroom/$id")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("../_admin.admin.classrooms._id-D3x3r4hK.mjs");
const Route$2 = createFileRoute("/_admin/admin/classrooms/$id")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("../_admin.admin.classes._classId.students-M-TEeNYx.mjs");
const Route$1 = createFileRoute("/_admin/admin/classes/$classId/students")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("../_admin.admin.classes._classId.attendance-D5Y3X9FM.mjs");
const Route = createFileRoute("/_admin/admin/classes/$classId/attendance")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const PlacementsRoute = Route$D.update({
  id: "/placements",
  path: "/placements",
...
export {
  ...
  formatDuration as A,
  formatTime as B,
  generateQuizFromPdf as C,
  getAdminPrograms as D,
  getAdminUsers as E,
  getAssetUrl as F,
  getChatUsers as G,
  getClassAttendance as H,
  getClassAttendanceReport as I,
  getClassStudents as J,
  getClassroomById as K,
  getClassroomMeetings as L,
  getClassrooms as M,
  getConversation as N,
  getDetailedProgress as O,
  getExamType as P,
  getGrade as Q,
  Route$s as R,
  getMyClassrooms as S,
  getMyMeetings as T,
  getMyNotifications as U,
  getPublicPrograms as V,
  getQuizAttemptResult as W,
  getQuizReport as X,
  getRecordingStreamUrl as Y,
  getStudentAttendanceDetails as Z,
  heartbeatMeetingByRoomId as _,
  Route$5 as a,
  joinMeetingByRoomId as a0,
  leaveMeetingByRoomId as a1,
  loginUser as a2,
  logoutUser as a3,
  markClassroomFresh as a4,
  messageActions as a5,
  publishQuiz as a6,
  publishRecording as a7,
  reuseClassroomRecording as a8,
  router as a9,
  saveAttendance as aa,
  saveQuizAnswer as ab,
  sendMessage as ac,
  startMeeting as ad,
  startQuizAttempt as ae,
  submitQuizAttempt as af,
  trackRecordingProgress as ag,
  uid as ah,
  unpublishRecording as ai,
  updateAdminProgram as aj,
  updateClassroom as ak,
  updateClassroomStudentStatus as al,
  updateMyProfile as am,
  updateQuiz as an,
  updateStudentCertificate as ao,
  uploadClassroomRecordingToCloudflare as ap,
  uploadProfileAvatar as aq,
  useClassroomStore as ar,
  Route$4 as b,
  Route$3 as c,
  Route$2 as d,
  Route$1 as e,
  ...
  adminActions as h,
  api as i,
  archiveClassroom as j,
  classroomActions as k,
  classroomStore as l,
  closeQuiz as m,
  computeCertificates as n,
  createAdminProgram as o,
  createAdminUser as p,
  createClassroom as q,
  createClassroomAnnouncement as r,
  createMeeting as s,
  createQuiz as t,
  deleteAdminProgram as u,
  deleteClassroomAnnouncement as v,
  deleteMeeting as w,
  deleteQuiz as x,
  deleteRecording as y,
  endMeeting as z
};
