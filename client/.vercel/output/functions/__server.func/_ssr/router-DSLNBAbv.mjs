...
function normalizeBackendClassroom(raw) {
  ...
  const computeStudentMetrics = (studentId) => {
    ...
    const progress = progressParts.length ? Math.round(progressParts.reduce((sum, pct) => sum + pct, 0) / progressParts.length) : 0;
...
async function uploadClassroomFileToCloudinary({
  file,
  onProgress
}) {
  const accessToken = classroomStore.getState().accessToken;
...
const appCss = "/assets/styles-VMiafevA.css";
...
const $$splitComponentImporter$A = () => import("./placements-DZXVlXV5.mjs");
const Route$A = createFileRoute("/placements")({
  component: lazyRouteComponent($$splitComponentImporter$A, "component")
});
const $$splitComponentImporter$z = () => import("./login-D2S9WHW6.mjs");
const Route$z = createFileRoute("/login")({
  component: lazyRouteComponent($$splitComponentImporter$z, "component")
});
const $$splitComponentImporter$y = () => import("./faculty-D7npIbBw.mjs");
const Route$y = createFileRoute("/faculty")({
  component: lazyRouteComponent($$splitComponentImporter$y, "component")
});
const $$splitComponentImporter$x = () => import("./enroll-bvBJjo7t.mjs");
const Route$x = createFileRoute("/enroll")({
  component: lazyRouteComponent($$splitComponentImporter$x, "component")
});
const $$splitComponentImporter$w = () => import("./courses-D5G71N8v.mjs");
const Route$w = createFileRoute("/courses")({
  component: lazyRouteComponent($$splitComponentImporter$w, "component")
});
const $$splitComponentImporter$v = () => import("./contact-p3fLV3RF.mjs");
const Route$v = createFileRoute("/contact")({
  component: lazyRouteComponent($$splitComponentImporter$v, "component")
});
const $$splitComponentImporter$u = () => import("./blog-BoqRUlWV.mjs");
const Route$u = createFileRoute("/blog")({
  component: lazyRouteComponent($$splitComponentImporter$u, "component")
});
const $$splitComponentImporter$t = () => import("./about-BMIcY36C.mjs");
const Route$t = createFileRoute("/about")({
  component: lazyRouteComponent($$splitComponentImporter$t, "component")
});
const $$splitComponentImporter$s = () => import("../_student-B4rml_PM.mjs");
const Route$s = createFileRoute("/_student")({
  component: lazyRouteComponent($$splitComponentImporter$s, "component")
});
const $$splitComponentImporter$r = () => import("../_admin-BqTIEU-A.mjs");
const Route$r = createFileRoute("/_admin")({
  component: lazyRouteComponent($$splitComponentImporter$r, "component")
});
const $$splitComponentImporter$q = () => import("./index-Ba78lvBR.mjs");
const Route$q = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$q, "component")
});
const $$splitComponentImporter$p = () => import("../_student.student.schedule-D7nfsgWE.mjs");
const Route$p = createFileRoute("/_student/student/schedule")({
  component: lazyRouteComponent($$splitComponentImporter$p, "component")
});
const $$splitComponentImporter$o = () => import("../_student.student.profile-BZw5BM6r.mjs");
const Route$o = createFileRoute("/_student/student/profile")({
  component: lazyRouteComponent($$splitComponentImporter$o, "component")
});
const $$splitComponentImporter$n = () => import("../_student.student.messages-CzUocuWk.mjs");
const Route$n = createFileRoute("/_student/student/messages")({
  component: lazyRouteComponent($$splitComponentImporter$n, "component")
});
const $$splitComponentImporter$m = () => import("../_student.student.live-D7zfod_3.mjs");
const Route$m = createFileRoute("/_student/student/live")({
  component: lazyRouteComponent($$splitComponentImporter$m, "component")
});
const $$splitComponentImporter$l = () => import("../_student.student.exams-CYmnMhe1.mjs");
const Route$l = createFileRoute("/_student/student/exams")({
  component: lazyRouteComponent($$splitComponentImporter$l, "component")
});
const $$splitComponentImporter$k = () => import("../_student.student.dashboard-Cjq5_ZjH.mjs");
const Route$k = createFileRoute("/_student/student/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$k, "component")
});
const $$splitComponentImporter$j = () => import("../_student.student.certificates-sgCwgtB_.mjs");
const Route$j = createFileRoute("/_student/student/certificates")({
  component: lazyRouteComponent($$splitComponentImporter$j, "component")
});
const $$splitComponentImporter$i = () => import("../_admin.admin.students-CYL1bzEt.mjs");
const Route$i = createFileRoute("/_admin/admin/students")({
  component: lazyRouteComponent($$splitComponentImporter$i, "component")
});
const $$splitComponentImporter$h = () => import("../_admin.admin.settings-BjsdnBEj.mjs");
const Route$h = createFileRoute("/_admin/admin/settings")({
  component: lazyRouteComponent($$splitComponentImporter$h, "component")
});
const $$splitComponentImporter$g = () => import("../_admin.admin.placements-wqrzui-S.mjs");
const Route$g = createFileRoute("/_admin/admin/placements")({
  component: lazyRouteComponent($$splitComponentImporter$g, "component")
});
const $$splitComponentImporter$f = () => import("../_admin.admin.finance-DwNIdcDF.mjs");
const Route$f = createFileRoute("/_admin/admin/finance")({
  component: lazyRouteComponent($$splitComponentImporter$f, "component")
});
const $$splitComponentImporter$e = () => import("../_admin.admin.faculty-BGue1DTD.mjs");
const Route$e = createFileRoute("/_admin/admin/faculty")({
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import("../_admin.admin.exams-_s_y0Fat.mjs");
const Route$d = createFileRoute("/_admin/admin/exams")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("../_admin.admin.dashboard-0YEoVF81.mjs");
const Route$c = createFileRoute("/_admin/admin/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("../_admin.admin.courses-CQqxjvAu.mjs");
const Route$b = createFileRoute("/_admin/admin/courses")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("../_admin.admin.analytics-R5MoENvk.mjs");
const Route$a = createFileRoute("/_admin/admin/analytics")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("../_student.student.my-courses.index-BKgsDthl.mjs");
const Route$9 = createFileRoute("/_student/student/my-courses/")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("../_student.student.classrooms.index-D5CVsUgX.mjs");
const Route$8 = createFileRoute("/_student/student/classrooms/")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("../_admin.admin.classrooms.index-7LXF6pEv.mjs");
const Route$7 = createFileRoute("/_admin/admin/classrooms/")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("../_admin.admin.classes.index-D1rW9XxR.mjs");
const Route$6 = createFileRoute("/_admin/admin/classes/")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("../_student.student.webex._roomId-Cw1q93lC.mjs");
const Route$5 = createFileRoute("/_student/student/webex/$roomId")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("../_student.student.course._id-C-5mxgNF.mjs");
const Route$4 = createFileRoute("/_student/student/course/$id")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("../_student.student.classroom._id-E3b5NQrq.mjs");
const Route$3 = createFileRoute("/_student/student/classroom/$id")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("../_admin.admin.classrooms._id-CoLAb8JP.mjs");
const Route$2 = createFileRoute("/_admin/admin/classrooms/$id")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("../_admin.admin.classes._classId.students-DUMfx6JX.mjs");
const Route$1 = createFileRoute("/_admin/admin/classes/$classId/students")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("../_admin.admin.classes._classId.attendance-50Wi4wKx.mjs");
const Route = createFileRoute("/_admin/admin/classes/$classId/attendance")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const PlacementsRoute = Route$A.update({
  id: "/placements",
  path: "/placements",
...
const FacultyRoute = Route$y.update({
  id: "/faculty",
  path: "/faculty",
  getParentRoute: () => Route$B
});
const EnrollRoute = Route$x.update({
  id: "/enroll",
  path: "/enroll",
  getParentRoute: () => Route$B
});
const CoursesRoute = Route$w.update({
  id: "/courses",
  path: "/courses",
  getParentRoute: () => Route$B
});
...
const StudentRoute = Route$s.update({
  id: "/_student",
  getParentRoute: () => Route$B
});
...
const StudentStudentScheduleRoute = Route$p.update({
  id: "/student/schedule",
  path: "/student/schedule",
  getParentRoute: () => StudentRoute
});
const StudentStudentProfileRoute = Route$o.update({
  id: "/student/profile",
  path: "/student/profile",
  getParentRoute: () => StudentRoute
});
const StudentStudentMessagesRoute = Route$n.update({
  id: "/student/messages",
  path: "/student/messages",
  getParentRoute: () => StudentRoute
});
const StudentStudentLiveRoute = Route$m.update({
  id: "/student/live",
  path: "/student/live",
  getParentRoute: () => StudentRoute
});
const StudentStudentExamsRoute = Route$l.update({
  id: "/student/exams",
  path: "/student/exams",
  getParentRoute: () => StudentRoute
});
const StudentStudentDashboardRoute = Route$k.update({
  id: "/student/dashboard",
  path: "/student/dashboard",
  getParentRoute: () => StudentRoute
});
const StudentStudentCertificatesRoute = Route$j.update({
  id: "/student/certificates",
  path: "/student/certificates",
  getParentRoute: () => StudentRoute
});
const AdminAdminStudentsRoute = Route$i.update({
  id: "/admin/students",
  path: "/admin/students",
  getParentRoute: () => AdminRoute
});
const AdminAdminSettingsRoute = Route$h.update({
  id: "/admin/settings",
  path: "/admin/settings",
  getParentRoute: () => AdminRoute
});
const AdminAdminPlacementsRoute = Route$g.update({
  id: "/admin/placements",
  path: "/admin/placements",
  getParentRoute: () => AdminRoute
});
const AdminAdminFinanceRoute = Route$f.update({
  id: "/admin/finance",
  path: "/admin/finance",
  getParentRoute: () => AdminRoute
});
const AdminAdminFacultyRoute = Route$e.update({
  id: "/admin/faculty",
  path: "/admin/faculty",
  getParentRoute: () => AdminRoute
});
const AdminAdminExamsRoute = Route$d.update({
  id: "/admin/exams",
  path: "/admin/exams",
  getParentRoute: () => AdminRoute
});
const AdminAdminDashboardRoute = Route$c.update({
  id: "/admin/dashboard",
  path: "/admin/dashboard",
  getParentRoute: () => AdminRoute
});
const AdminAdminCoursesRoute = Route$b.update({
  id: "/admin/courses",
  path: "/admin/courses",
  getParentRoute: () => AdminRoute
});
...
export {
  logoutUser as $,
  getAdminPrograms as A,
  getAdminUsers as B,
  getAssetUrl as C,
  getClassAttendance as D,
  getClassAttendanceReport as E,
  getClassStudents as F,
  getClassroomById as G,
  getClassroomMeetings as H,
  getClassrooms as I,
  getDetailedProgress as J,
  getExamType as K,
  getGrade as L,
  getMeetingByRoomId as M,
  getMyClassrooms as N,
  getMyMeetings as O,
  getMyNotifications as P,
  getPublicPrograms as Q,
  Route$5 as R,
  getQuizAttemptResult as S,
  getQuizReport as T,
  getRecordingStreamUrl as U,
  getStudentAttendanceDetails as V,
  heartbeatMeetingByRoomId as W,
  isClassroomStale as X,
  joinMeetingByRoomId as Y,
  leaveMeetingByRoomId as Z,
  loginUser as _,
  Route$4 as a,
  markClassroomFresh as a0,
  messageActions as a1,
  publishQuiz as a2,
  publishRecording as a3,
  registerStudent as a4,
  reuseClassroomRecording as a5,
  router as a6,
  saveAttendance as a7,
  saveQuizAnswer as a8,
  startMeeting as a9,
  startQuizAttempt as aa,
  submitQuizAttempt as ab,
  trackRecordingProgress as ac,
  uid as ad,
  unpublishRecording as ae,
  updateAdminProgram as af,
  updateClassroomStudentStatus as ag,
  updateQuiz as ah,
  uploadClassroomFileToCloudinary as ai,
  uploadClassroomRecordingToCloudflare as aj,
  useClassroomStore as ak,
  Route$3 as b,
  Route$2 as c,
  Route$1 as d,
  Route as e,
  addStudentsToClassroom as f,
  adminActions as g,
  api as h,
  classroomActions as i,
  classroomStore as j,
  closeQuiz as k,
  computeCertificates as l,
  createAdminProgram as m,
  createAdminUser as n,
  createClassroom as o,
  createClassroomAnnouncement as p,
  createMeeting as q,
  createQuiz as r,
  deleteAdminProgram as s,
  deleteClassroomAnnouncement as t,
  deleteMeeting as u,
  deleteQuiz as v,
  deleteRecording as w,
  endMeeting as x,
  formatDuration as y,
  formatTime as z
};
