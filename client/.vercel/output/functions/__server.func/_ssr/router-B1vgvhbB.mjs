...
const appCss = "/assets/styles-CqaEVz7l.css";
...
const $$splitComponentImporter$w = () => import("./login-B3zic_RE.mjs");
...
const $$splitComponentImporter$u = () => import("./enroll-B0OrHqVI.mjs");
...
const $$splitComponentImporter$p = () => import("../_student-CzFNmTt1.mjs");
const Route$p = createFileRoute("/_student")({
  component: lazyRouteComponent($$splitComponentImporter$p, "component")
});
const $$splitComponentImporter$o = () => import("../_admin-Y2p0bWJA.mjs");
const Route$o = createFileRoute("/_admin")({
  component: lazyRouteComponent($$splitComponentImporter$o, "component")
});
const $$splitComponentImporter$n = () => import("./index-DdYXYoGm.mjs");
const Route$n = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$n, "component")
});
const $$splitComponentImporter$m = () => import("../_student.student.schedule-DKKXFe8L.mjs");
const Route$m = createFileRoute("/_student/student/schedule")({
  component: lazyRouteComponent($$splitComponentImporter$m, "component")
});
const $$splitComponentImporter$l = () => import("../_student.student.profile-_--g5vqQ.mjs");
const Route$l = createFileRoute("/_student/student/profile")({
  component: lazyRouteComponent($$splitComponentImporter$l, "component")
});
const $$splitComponentImporter$k = () => import("../_student.student.messages-ndef0_u2.mjs");
const Route$k = createFileRoute("/_student/student/messages")({
  component: lazyRouteComponent($$splitComponentImporter$k, "component")
});
const $$splitComponentImporter$j = () => import("../_student.student.live-BufTidyB.mjs");
const Route$j = createFileRoute("/_student/student/live")({
  component: lazyRouteComponent($$splitComponentImporter$j, "component")
});
const $$splitComponentImporter$i = () => import("../_student.student.exams-HfYl_aj1.mjs");
const Route$i = createFileRoute("/_student/student/exams")({
  component: lazyRouteComponent($$splitComponentImporter$i, "component")
});
const $$splitComponentImporter$h = () => import("../_student.student.dashboard-BfgJ-3Y-.mjs");
const Route$h = createFileRoute("/_student/student/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$h, "component")
});
const $$splitComponentImporter$g = () => import("../_student.student.certificates-DfqjDV1Q.mjs");
const Route$g = createFileRoute("/_student/student/certificates")({
  component: lazyRouteComponent($$splitComponentImporter$g, "component")
});
const $$splitComponentImporter$f = () => import("../_admin.admin.students-cqM7OEpI.mjs");
const Route$f = createFileRoute("/_admin/admin/students")({
  component: lazyRouteComponent($$splitComponentImporter$f, "component")
});
const $$splitComponentImporter$e = () => import("../_admin.admin.settings-BwYSbJvm.mjs");
const Route$e = createFileRoute("/_admin/admin/settings")({
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import("../_admin.admin.placements-WdqY3zwE.mjs");
const Route$d = createFileRoute("/_admin/admin/placements")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("../_admin.admin.finance-DG8xxgvt.mjs");
const Route$c = createFileRoute("/_admin/admin/finance")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("../_admin.admin.faculty-Sjm2Jy58.mjs");
const Route$b = createFileRoute("/_admin/admin/faculty")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("../_admin.admin.exams-kBcls6yc.mjs");
const Route$a = createFileRoute("/_admin/admin/exams")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("../_admin.admin.dashboard-iW6aHp1p.mjs");
const Route$9 = createFileRoute("/_admin/admin/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("../_admin.admin.courses-CU05C-px.mjs");
const Route$8 = createFileRoute("/_admin/admin/courses")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("../_admin.admin.analytics-DuYaAh1o.mjs");
const Route$7 = createFileRoute("/_admin/admin/analytics")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("../_student.student.my-courses.index-DIrU27mQ.mjs");
const Route$6 = createFileRoute("/_student/student/my-courses/")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("../_student.student.classrooms.index-CR-kjh3i.mjs");
const Route$5 = createFileRoute("/_student/student/classrooms/")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("../_admin.admin.classrooms.index-DGqdnqoi.mjs");
const Route$4 = createFileRoute("/_admin/admin/classrooms/")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("../_student.student.jitsi._roomId-gadLlNBK.mjs");
const Route$3 = createFileRoute("/_student/student/jitsi/$roomId")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("../_student.student.course._id-CX9LZiEa.mjs");
const Route$2 = createFileRoute("/_student/student/course/$id")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("../_student.student.classroom._id-BCghMYFc.mjs");
const Route$1 = createFileRoute("/_student/student/classroom/$id")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("../_admin.admin.classrooms._id-BwZTDguW.mjs");
...
export {
  getGrade as A,
  getMyClassrooms as B,
  getMyMeetings as C,
  getMyNotifications as D,
  getQuizAttemptResult as E,
  getQuizReport as F,
  getRecordingStreamUrl as G,
  loginUser as H,
  logoutUser as I,
  messageActions as J,
  publishQuiz as K,
  publishRecording as L,
  registerStudent as M,
  router as N,
  saveQuizAnswer as O,
  startQuizAttempt as P,
  submitQuizAttempt as Q,
  Route$3 as R,
  uid as S,
  unpublishRecording as T,
  updateAdminProgram as U,
  updateClassroomStudentStatus as V,
  uploadClassroomRecordingToCloudflare as W,
  useClassroomStore as X,
  Route$2 as a,
  Route$1 as b,
  Route as c,
