...
import { i as api } from "./router-Mu5AAhdf.mjs";
import "../_libs/firebase.mjs";
import "../_libs/firebase__messaging.mjs";
import { i as Building2, S as MapPin, al as TrendingUp } from "../_libs/lucide-react.mjs";
...
function Placements() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PublicLayout, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 lg:py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-5 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3", children: hospitals.map((h) => {
        const name = typeof h === "string" ? h : h.name;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-6 text-center hover:border-plum-dark/30 transition", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { className: "h-7 w-7 mx-auto text-plum" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 font-display text-sm font-semibold text-plum-dark", children: name })
        ] }, name);
      }) })
    ] }) }),
