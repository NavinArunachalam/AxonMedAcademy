...
import { P as PublicLayout } from "./Layout-Ds2ClE8w.mjs";
import { ar as useClassroomStore, V as getPublicPrograms, F as getAssetUrl, i as api } from "./router-CFicUlxS.mjs";
import { B as BlogDetailModal } from "./BlogDetailModal-DGhR4u1s.mjs";
import "../_libs/firebase.mjs";
import "../_libs/firebase__messaging.mjs";
import { m as motion, A as AnimatePresence } from "../_libs/framer-motion.mjs";
import { ah as Sparkles, e as ArrowRight, a3 as Play, f as ArrowUpRight, P as LoaderCircle, h as BookOpen, y as Clock, as as Users, aj as Star, at as Video, af as ShieldCheck, g as Award, i as Briefcase, z as CreditCard, w as ClipboardCheck, I as GraduationCap, aa as ScrollText, p as ChevronLeft, q as ChevronRight, a5 as Quote, au as X, Z as Minus, a4 as Plus, K as HeartPulse, A as Activity, Y as Microscope, a2 as Pill } from "../_libs/lucide-react.mjs";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-7", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.p,
          {
            ...
            children: "Master concepts, practice high-yield MCQs, and achieve top ranks in AIAPGET & MRB with structured, result-driven learning."
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group relative overflow-hidden rounded-3xl border border-border bg-card p-6 hover:border-plum-dark/30 hover:-translate-y-1 transition-all", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex items-center justify-between border-t border-border pt-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/enroll", className: "rounded-full bg-plum-dark px-4 py-2 text-xs font-semibold text-cream hover:bg-plum transition", children: "Enroll →" })
          ] })
        ] })
      ] }, c.id);
    }) })
...
function WhyUs() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-10 lg:py-16 bg-secondary/40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto w-full max-w-[1400px] px-5 lg:px-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-14 grid gap-px bg-border rounded-3xl overflow-hidden lg:grid-cols-3 sm:grid-cols-2", children: items.map((it) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group bg-card p-8 hover:bg-plum-dark transition-colors duration-300", children: [
...
const API_BASE = (() => {
  const runtime = "https://oc-pro-production.up.railway.app/api/v1";
...
function VideoThumbnail({ video, streamUrl, className }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `absolute inset-0 ${className || ""}`, children: [
    thumb ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: thumb, alt: "", className: "w-full h-full object-cover" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-plum to-plum-dark" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-noise opacity-30" })
  ] });
}
function Testimonials() {
  ...
  const [videoError, setVideoError] = reactExports.useState(null);
  reactExports.useEffect(() => {
    api.get("/public/testimonials").then((res) => {
      if (res.success && res.testimonials?.length > 0) setTestimonials(res.testimonials);
    }).catch(() => {
    });
    api.get("/public/review-videos").then((res) => {
      if (res.success) setReviewVideos(res.videos || []);
    }).catch(() => {
    });
  }, []);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-10 lg:py-16 bg-secondary/40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto w-full max-w-[1400px] px-5 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-between flex-wrap gap-6 mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-xl", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 lg:grid-cols-3", children: displayItems.slice(0, 3).map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `relative rounded-3xl p-7 border ${i === 1 ? "bg-plum-dark text-cream border-plum-dark" : "bg-card border-border"}`, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-11 w-11 overflow-hidden rounded-full flex items-center justify-center font-display font-bold text-sm shrink-0 ${i === 1 ? "bg-lime text-plum-dark" : "bg-plum-dark text-lime"}`, children: t.image ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: t.image, alt: t.name, className: "h-full w-full object-cover rounded-full" }) : t.initials || t.name.charAt(0) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `font-semibold text-sm ${i === 1 ? "text-cream" : "text-plum-dark"}`, children: t.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `text-xs ${i === 1 ? "text-cream/65" : "text-foreground/60"}`, children: t.roll })
          ] })
        ] })
      ] }, t._id || t.name)) }),
      reviewVideos.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 grid gap-5 sm:grid-cols-3", children: reviewVideos.slice(0, 3).map((v) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          onClick: () => {
            setActiveVideo(v);
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent px-4 py-3 text-left", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-cream text-xs font-semibold truncate", children: v.title }),
              v.studentName && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-cream/65 text-[10px] truncate", children: [
                v.studentName,
                v.roll ? ` · ${v.roll}` : ""
              ] })
            ] })
      ...
      reviewVideos.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 grid gap-5 sm:grid-cols-3", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "group relative aspect-video overflow-hidden rounded-2xl bg-gradient-to-br from-plum to-plum-dark", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-noise opacity-30" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 grid place-items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid h-14 w-14 place-items-center rounded-full bg-lime text-plum-dark group-hover:scale-110 transition-transform", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "h-5 w-5 fill-current" }) }) }),
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aspect-video bg-black", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "video",
                  {
                  ...
                  activeVideo._id || activeVideo.id
                ),
                videoError && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center bg-black/80", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-cream text-sm px-4 text-center", children: videoError }) })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-cream text-base", children: activeVideo.title }),
                activeVideo.studentName && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-cream/60 text-xs mt-1", children: [
                  activeVideo.studentName,
                  activeVideo.roll ? ` · ${activeVideo.roll}` : ""
                ] })
              ] })
            ]
          }
...
function BlogPreview() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "py-10 lg:py-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto w-full max-w-[1400px] px-5 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-between flex-wrap gap-6 mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 lg:grid-cols-3", children: posts.map((p, index) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "group rounded-3xl overflow-hidden bg-card border border-border hover:-translate-y-1 transition-all flex flex-col", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `relative aspect-[16/10] ${p.image ? "" : "bg-gradient-to-br " + tint} overflow-hidden`, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 flex flex-col flex-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-foreground/70 leading-relaxed line-clamp-3", children: p.excerpt }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
