...
import { S as StatTile, C as Card } from "./_ssr/PortalShell-232oUaaL.mjs";
import { i as useClassroomStore } from "./_ssr/classroomStore-B40uasVO.mjs";
import { u as useQuery } from "./_libs/tanstack__react-query.mjs";
import { k as getMyMeetings, l as getMyNotifications } from "./_ssr/api-GlGI6V_B.mjs";
import { s as CirclePlay, g as BookOpen, v as Clock, r as CircleCheck, al as Trophy, o as ChevronRight, y as Flame } from "./_libs/lucide-react.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-4 space-y-3", children: [
          upcomingEvents.map((e) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-4 rounded-xl border border-border p-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: `text-xs font-semibold rounded-full px-3 py-1.5 ${e.status === "live" ? "bg-red-500/20 text-red-600" : "bg-plum-dark text-cream"}`, children: e.status === "live" ? "Live" : "Join" })
          ] }, e.id)),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 space-y-3", children: joinableNotifications.length > 0 ? joinableNotifications.map((notif) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border border-border p-4 bg-slate-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: notif.actionUrl || "#", className: "rounded-full bg-lime px-4 py-2 text-xs font-semibold text-plum-dark hover:bg-lime/90", children: "Join now" })
