...
import { i as api, D as getAssetUrl } from "./_ssr/router-7BnTJDC3.mjs";
import { D as DarkCard } from "./_ssr/PortalShell-BrkJ3mSa.mjs";
import "./_libs/firebase.mjs";
import "./_libs/firebase__messaging.mjs";
import { i as Building2, a3 as Save, g as BookOpen, $ as Plus, X as Pen, ah as Trash2, an as Users, ap as X, al as Upload, ae as Star, F as FileText } from "./_libs/lucide-react.mjs";
...
function Settings() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 text-cream pb-12", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 lg:grid-cols-[220px_1fr]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("aside", { className: "space-y-1", children: ["Organization", "About", "Faculty", "Placement", "Blog"].map((tab) => {
