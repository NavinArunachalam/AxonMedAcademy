...
import { C as Card } from "./_ssr/PortalShell-BbXObVDa.mjs";
import { ar as useClassroomStore, h as adminActions, am as updateMyProfile, aq as uploadProfileAvatar } from "./_ssr/router-CFicUlxS.mjs";
import "./_libs/firebase.mjs";
import "./_libs/firebase__messaging.mjs";
import { $ as PenLine, S as Mail, a1 as Phone, T as MapPin, I as GraduationCap, i as Briefcase, au as X, u as CircleCheckBig, s as CircleAlert, P as LoaderCircle, a8 as Save, k as Camera } from "./_libs/lucide-react.mjs";
...
function Profile() {
  ...
  enrolled.length > 0 ? new Date(enrolled[0].students.find((s) => s.id === studentId).addedAt).getFullYear() : (/* @__PURE__ */ new Date()).getFullYear();
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mx-auto max-w-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl bg-gradient-to-br from-plum-dark via-plum to-[#1a0a2e] text-cream p-6 shadow-2xl border border-white/10 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-[0.2em] text-lime font-bold mb-1", children: "AXON MED ACADEMY" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 pt-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-lime bg-white/10 px-3 py-1 rounded-lg border border-lime/30 shadow-xs shadow-lime/10", children: displayId })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
