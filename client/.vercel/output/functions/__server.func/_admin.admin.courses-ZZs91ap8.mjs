...
import { Y as useClassroomStore, v as getAdminPrograms, p as deleteAdminProgram, V as updateAdminProgram, j as createAdminProgram } from "./_ssr/router-B58fWewC.mjs";
