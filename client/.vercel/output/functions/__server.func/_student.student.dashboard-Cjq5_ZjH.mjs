...
import { S as StatTile, C as Card$1 } from "./_ssr/PortalShell-DpJHKv_h.mjs";
import { ak as useClassroomStore, O as getMyMeetings, J as getDetailedProgress, P as getMyNotifications } from "./_ssr/router-DSLNBAbv.mjs";
...
import { s as CirclePlay, g as BookOpen, v as Clock, r as CircleCheck, al as Trophy, o as ChevronRight, x as Flame, a1 as Radio, D as Download, aj as TrendingUp, j as ChartColumn, ao as Users, ap as Video, F as FileText } from "./_libs/lucide-react.mjs";
...
function Dashboard() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 lg:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card$1, { className: "lg:col-span-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card$1, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-4 space-y-3", children: [
          upcomingEvents.map((e) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-4 rounded-xl border border-border p-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `/student/webex/${e.roomId}`, className: `text-xs font-semibold rounded-full px-3 py-1.5 flex items-center gap-1.5 ${e.status === "live" ? "bg-red-500 text-white" : "bg-plum-dark text-cream"}`, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card$1, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-4 space-y-3", children: [
          studentAnnouncements.map((a) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "rounded-xl bg-secondary p-3.5", children: [
            ...
            a.attachments && a.attachments.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 flex gap-1.5", children: a.attachments.map((at, i) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: proxyUrl, target: "_blank", rel: "noreferrer", className: "inline-flex items-center gap-1.5 rounded-lg bg-white/50 px-2 py-1 text-[10px] font-bold text-plum hover:bg-white transition-colors", children: [
