...
import { b as Route$1, G as useClassroomStore, n as formatDuration, f as classroomActions, x as getRecordingStreamUrl } from "./_ssr/router-CuPinYbg.mjs";
import { O as Lock, c as ArrowLeft, S as Megaphone, aq as Video, a3 as Radio, C as Calendar, v as Clock, g as BookOpen, a0 as Play, u as ClipboardList, l as Check, ar as X, am as Trophy } from "./_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-50 bg-black flex flex-col", onContextMenu: (e) => e.preventDefault(), children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 relative select-none", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 bg-linear-to-br from-plum-dark/90 to-[#0B0719] flex items-center justify-center relative", children: [
        ...
        streamUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx("video", { ref: videoRef, src: streamUrl, crossOrigin: "use-credentials", className: "w-full h-full object-contain bg-black", controls: true, poster: "/default-video-thumb.jpg", onPlay: () => setIsPlaying(true), onPause: () => setIsPlaying(false) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
          if (blurred) return;
          setIsPlaying((p) => !p);
