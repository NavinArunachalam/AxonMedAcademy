...
import { R as Route$5, Z as leaveMeetingByRoomId, W as heartbeatMeetingByRoomId, M as getMeetingByRoomId, Y as joinMeetingByRoomId } from "./_ssr/router-CMo-f-AL.mjs";
import { ap as Video, aq as X } from "./_libs/lucide-react.mjs";
...
function WebexRoom() {
  ...
  const hasLeftRef = reactExports.useRef(false);
  const leaveMeeting = reactExports.useCallback(() => {
  ...
  if (meeting.status === "ended") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-screen items-center justify-center bg-black text-white p-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-20 w-20 bg-white/10 rounded-3xl flex items-center justify-center mx-auto mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Video, { className: "h-10 w-10 text-white/20" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold mb-4", children: "Class Ended" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 mb-8", children: "This session has been completed by the instructor." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleClose, className: "rounded-full bg-white text-black px-8 py-3 font-bold hover:bg-white/90 transition-colors", children: "Back to Dashboard" })
    ] }) });
  }
