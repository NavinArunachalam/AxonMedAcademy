...
import { D as DarkCard } from "./_ssr/PortalShell-B5wQZJyj.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DarkCard, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(LuLink, { className: "h-3.5 w-3.5 text-cream/60" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "url", value: driveLink, onChange: (e) => setDriveLink(e.target.value), placeholder: "Paste Google Drive PDF link...", disabled: isPosting, className: "w-64 bg-cream/5 border border-cream/10 rounded-lg px-3 py-1.5 text-cream text-xs outline-none focus:border-lime/50 disabled:opacity-50" }),
          driveLink && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setDriveLink(""), disabled: isPosting, className: "text-cream/40 hover:text-red-400", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LuX, { className: "h-3 w-3" }) })
        ] }) }),
