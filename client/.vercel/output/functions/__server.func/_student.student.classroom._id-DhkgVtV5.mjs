  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-50 bg-black flex flex-col no-select select-none", onContextMenu: (e) => e.preventDefault(), children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 relative select-none", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 bg-linear-to-br from-plum-dark/90 to-[#0B0719] flex items-center justify-center relative", children: [
        streamUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx("video", { ref: videoRef, src: streamUrl, crossOrigin: "use-credentials", className: "w-full h-[95vh] object-contain bg-black no-select select-none", controls: true, controlsList: "nodownload", poster: "/default-video-thumb.jpg", onPlay: () => setIsPlaying(true), onPause: () => setIsPlaying(false), onDragStart: (e) => e.preventDefault() }) : /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
          if (isLocked) return;
          setIsPlaying((p) => !p);
        ...
        isLocked && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 backdrop-blur-xl bg-black/90 flex flex-col items-center justify-center z-30 p-6 transition-all duration-300", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-400 text-sm max-w-md text-center mb-6 leading-relaxed", children: lockReason === "shortcut" ? "A screenshot, screen-recording shortcut, or Developer Tools attempt was detected. For security reasons, playback has been locked." : "Browser focus was lost (possible application switch, notification shade, or screenshot tool). Please return to this tab to continue." }),
          ...
          }, className: "relative group overflow-hidden rounded-full bg-linear-to-r from-red-600 to-red-500 text-white px-8 py-3 text-sm font-bold shadow-lg hover:shadow-red-500/20 hover:scale-105 active:scale-95 transition-all duration-200", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative z-10", children: "Resume Playback" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 bg-white/10 opacity-0 group-hover:opacity-100 transition-opacity" })
          ] })
        ] })
      ] }),
