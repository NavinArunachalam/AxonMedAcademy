...
const findRouteRules = /* @__PURE__ */ (() => {
  const $0 = [{ name: "proxy", route: "/api/**", handler: proxy, options: { "to": "https://oc-pro-qqsz.vercel.app/api/v1/**", "_proxyStripBase": "/api" } }], $1 = [{ name: "headers", route: "/assets/**", handler: headers, options: { "cache-control": "public, max-age=31536000, immutable" } }];
  return (m, p) => {
    let r = [];
...
const _lazy_Q8aSWo = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
const findRoute = /* @__PURE__ */ (() => {
  const data = { route: "/**", handler: _lazy_Q8aSWo };
  return ((_m, p) => {
