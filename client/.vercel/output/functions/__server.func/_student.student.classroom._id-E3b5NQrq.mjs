...
import { k as LuMegaphone, s as LuVideo, d as LuCircleDot, e as LuClipboardList } from "./_libs/react-icons.mjs";
import { b as Route$3, ak as useClassroomStore, X as isClassroomStale, G as getClassroomById, i as classroomActions, a0 as markClassroomFresh, y as formatDuration, a8 as saveQuizAnswer, ab as submitQuizAttempt, S as getQuizAttemptResult, U as getRecordingStreamUrl, ac as trackRecordingProgress, aa as startQuizAttempt } from "./_ssr/router-DSLNBAbv.mjs";
import { M as Lock, c as ArrowLeft, Q as Megaphone, D as Download, ap as Video, a1 as Radio, C as Calendar, v as Clock, g as BookOpen, _ as Play, u as ClipboardList, l as Check, aq as X, al as Trophy, aa as ShieldAlert } from "./_libs/lucide-react.mjs";
    ...
    cls.announcements.map((ann) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border border-slate-200 bg-white p-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
        ...
        ann.attachments && ann.attachments.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 flex flex-wrap gap-2", children: ann.attachments.map((at, i) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: proxyUrl, target: "_blank", rel: "noreferrer", className: "inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-100 hover:text-plum-dark transition-colors", children: [
