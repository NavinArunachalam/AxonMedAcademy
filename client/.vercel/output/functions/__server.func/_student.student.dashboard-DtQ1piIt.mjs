...
import { S as StatTile, C as Card$1 } from "./_ssr/PortalShell-CXYBWu7m.mjs";
import { ao as useClassroomStore, Q as getMyMeetings, M as getDetailedProgress, S as getMyNotifications } from "./_ssr/router-Cwn_fQeX.mjs";
...
import { u as CirclePlay, g as BookOpen, x as Clock, s as CircleCheck, an as Trophy, p as ChevronRight, G as Flame, a4 as Radio, D as Download, al as TrendingUp, k as ChartColumn, aq as Users, ar as Video, F as FileText } from "./_libs/lucide-react.mjs";
...
function Dashboard() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatTile, { label: "Hours This Week", value: "0", delta: "0% vs last", icon: Clock, accent: "lime" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatTile, { label: "Achievement Points", value: "0", delta: "0% vs last", icon: Trophy, accent: "lime" })
    ] }),
