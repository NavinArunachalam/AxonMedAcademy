...
import { L as LuArrowLeft, i as LuMegaphone, q as LuVideo, d as LuCircleDot, e as LuClipboardList, p as LuUsers, m as LuSend, n as LuTrash2, k as LuPlus, l as LuRadio, b as LuCalendar, f as LuClock, j as LuPlay, o as LuUpload, r as LuX, a as LuBookOpen, h as LuEyeOff, g as LuEye, c as LuCheck } from "./_libs/react-icons.mjs";
import { D as DarkCard } from "./_ssr/PortalShell-DkPJSmXL.mjs";
import { c as Route, V as useClassroomStore, w as getClassroomById, f as classroomActions, s as formatDuration, Q as unpublishRecording, K as publishRecording, r as deleteRecording, E as getQuizReport, l as createClassroomAnnouncement, p as deleteClassroomAnnouncement, m as createMeeting, U as uploadClassroomRecordingToCloudflare, P as uid, n as createQuiz, J as publishQuiz, h as closeQuiz, q as deleteQuiz, v as getAdminUsers, d as addStudentsToClassroom, T as updateClassroomStudentStatus } from "./_ssr/router-B6mcLJS0.mjs";
    ...
    upcoming.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: upcoming.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs(DarkCard, { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 shrink-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => classroomActions.deleteMeeting(classroomId, m.id), disabled: deletingMeetingId === m.id, className: "rounded-full bg-cream/5 text-cream/40 hover:text-red-400 p-2 text-xs disabled:opacity-50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LuTrash2, { className: "h-3.5 w-3.5" }) })
        ] })
      ] }, m.id)) })
    ] }),
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-red-400", children: error }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: cls.recordings.map((rec) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(DarkCard, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-14 rounded-lg bg-linear-to-br from-lime/20 to-lime/5 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LuPlay, { className: "h-5 w-5 text-lime" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
  ...
  if (showBuilder) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setShowBuilder(false), className: "text-cream/60 hover:text-cream", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LuArrowLeft, { className: "h-5 w-5" }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: cls.quizzes.map((q) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx(DarkCard, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3 flex-wrap", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handleDeleteQuiz(q.id), disabled: quizOperationQuizId === q.id, className: "rounded-full bg-cream/5 text-cream/40 hover:text-red-400 p-2 disabled:cursor-not-allowed disabled:opacity-50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LuTrash2, { className: "h-3.5 w-3.5" }) })
        ] })
      ] }) }, q.id);
    }) })
  ] });
