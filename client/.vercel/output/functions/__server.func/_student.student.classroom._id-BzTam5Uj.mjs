...
import { b as Route$1, ab as useClassroomStore, P as isClassroomStale, B as getClassroomById, g as classroomActions, V as markClassroomFresh, w as formatDuration, a0 as saveQuizAnswer, a3 as submitQuizAttempt, L as getQuizAttemptResult, N as getRecordingStreamUrl, a4 as trackRecordingProgress, a2 as startQuizAttempt } from "./_ssr/router-D7_rFoRj.mjs";
import { M as Lock, c as ArrowLeft, Q as Megaphone, ao as Video, a1 as Radio, C as Calendar, v as Clock, g as BookOpen, _ as Play, u as ClipboardList, l as Check, ap as X, ak as Trophy, aa as ShieldAlert } from "./_libs/lucide-react.mjs";
  ...
  reactExports.useEffect(() => {
    ...
    const handleKeyDown = (e) => {
      ...
      if (e.key === "PrintScreen") {
        ...
        shouldLock = true;
      } else if ((e.ctrlKey || e.metaKey) && (e.shiftKey || e.altKey) && ["i", "j", "c"].includes(e.key.toLowerCase())) {
        shouldLock = true;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
    ...
    upcoming.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: upcoming.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `rounded-2xl border p-5 ${m.status === "live" ? "border-red-200 bg-red-50" : "border-slate-200 bg-white"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3 flex-wrap", children: [
        ...
        m.status === "live" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `/student/webex/${m.roomId}`, className: "rounded-full bg-red-500 text-white px-5 py-2.5 text-sm font-bold flex items-center gap-2 shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Radio, { className: "h-4 w-4" }),
          " Join Now"
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: `/student/webex/${m.roomId}`, className: "rounded-full bg-plum-dark text-cream px-5 py-2.5 text-sm font-bold flex items-center gap-2 shrink-0 hover:bg-plum transition-colors", children: "Join Class" })
      ] }) }, m.id)) })
    ] }),
...
function SecurePlayer({
  ...
  const [isDeclarationChecked, setIsDeclarationChecked] = reactExports.useState(false);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 relative select-none", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 bg-linear-to-br from-plum-dark/90 to-[#0B0719] flex items-center justify-center relative", children: [
        ...
        isLocked && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 backdrop-blur-xl bg-black/95 flex flex-col items-center justify-center z-30 p-6 transition-all duration-300", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-400 text-sm max-w-sm text-center mb-6 leading-relaxed", children: lockReason === "shortcut" ? "A screenshot, screen-recording shortcut, or Developer Tools attempt was detected." : "Focus was lost — this may indicate a screen recording tool, notification shade, or app switch." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-start gap-3 mb-6 cursor-pointer max-w-sm w-full bg-white/5 border border-white/10 rounded-2xl p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", checked: isDeclarationChecked, onChange: (e) => setIsDeclarationChecked(e.target.checked), className: "mt-0.5 h-4 w-4 rounded accent-red-500 shrink-0 cursor-pointer" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-slate-300 leading-relaxed", children: [
              "I confirm that I am ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-red-400 font-semibold", children: "not screen recording" }),
              ", casting, or capturing this video. I understand that unauthorized recording violates the platform's terms and may result in account suspension."
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { disabled: !isDeclarationChecked, onClick: () => {
          ...
          }, className: `relative group overflow-hidden rounded-full px-8 py-3 text-sm font-bold shadow-lg transition-all duration-200 ${isDeclarationChecked ? "bg-gradient-to-r from-red-600 to-red-500 text-white hover:shadow-red-500/20 hover:scale-105 active:scale-95" : "bg-white/10 text-white/30 cursor-not-allowed"}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative z-10", children: "Resume Playback" }),
            isDeclarationChecked && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 bg-white/10 opacity-0 group-hover:opacity-100 transition-opacity" })
          ] })
        ] })
      ] }),
