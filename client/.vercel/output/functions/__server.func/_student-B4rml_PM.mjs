...
import { P as PortalShell } from "./_ssr/PortalShell-DpJHKv_h.mjs";
import { ak as useClassroomStore, N as getMyClassrooms, i as classroomActions } from "./_ssr/router-DSLNBAbv.mjs";
