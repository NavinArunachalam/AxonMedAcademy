...
import { ao as useClassroomStore, h as adminActions, aj as updateMyProfile, an as uploadProfileAvatar } from "./_ssr/router-Mu5AAhdf.mjs";
...
function AvatarUploader({
  ...
  const apiBase = "https://oc-pro.onrender.com/api/v1".replace(/\/+$/, "") || "/api/v1";
