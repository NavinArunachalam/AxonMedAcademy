...
import { L as LuArrowLeft, m as LuMegaphone, v as LuVideo, e as LuCircleDot, f as LuClipboardList, u as LuUsers, l as LuLink, w as LuX, r as LuSend, s as LuTrash2, o as LuPlus, p as LuRadio, c as LuCalendar, g as LuClock, n as LuPlay, t as LuUpload, h as LuCopy, b as LuBookOpen, k as LuEyeOff, j as LuEye, i as LuDownload, d as LuCheck } from "./_libs/react-icons.mjs";
import { D as DarkCard } from "./_ssr/PortalShell-CzMijqXG.mjs";
import { d as Route$2, ap as useClassroomStore, J as getClassroomById, j as classroomActions, a3 as markClassroomFresh, _ as isClassroomStale, X as getRecordingStreamUrl, z as formatDuration, ah as unpublishRecording, a6 as publishRecording, x as deleteRecording, W as getQuizReport, q as createClassroomAnnouncement, u as deleteClassroomAnnouncement, r as createMeeting, ac as startMeeting, y as endMeeting, v as deleteMeeting, a7 as reuseClassroomRecording, an as uploadClassroomRecordingToCloudflare, ag as uid, B as generateQuizFromPdf, al as updateQuiz, s as createQuiz, a5 as publishQuiz, l as closeQuiz, w as deleteQuiz, D as getAdminUsers, g as addStudentsToClassroom, aj as updateClassroomStudentStatus } from "./_ssr/router-b9USinVv.mjs";
...
function AnnouncementsTab({
  ...
  const [driveLink, setDriveLink] = reactExports.useState("");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DarkCard, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between gap-3 mt-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3 w-full sm:w-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 w-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(LuLink, { className: "h-3.5 w-3.5 text-cream/60 shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "url", value: driveLink, onChange: (e) => setDriveLink(e.target.value), placeholder: "Paste Google Drive PDF link...", disabled: isPosting, className: "flex-1 sm:w-64 bg-cream/5 border border-cream/10 rounded-lg px-3 py-1.5 text-cream text-xs outline-none focus:border-lime/50 disabled:opacity-50" }),
          driveLink && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setDriveLink(""), disabled: isPosting, className: "text-cream/40 hover:text-red-400 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LuX, { className: "h-3 w-3" }) })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: handlePost, disabled: !text.trim() || isPosting, className: "w-full sm:w-auto justify-center inline-flex items-center gap-2 rounded-full bg-lime text-plum-dark px-5 py-2 text-sm font-bold disabled:opacity-40 shrink-0", children: [
      ...
      cls.announcements.map((ann) => /* @__PURE__ */ jsxRuntimeExports.jsx(DarkCard, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 flex-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
            ...
            ann.attachments && ann.attachments.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 flex flex-wrap gap-2", children: ann.attachments.map((at, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: at.url, target: "_blank", rel: "noreferrer", className: "inline-flex items-center gap-2 bg-cream/5 border border-cream/10 rounded-lg px-3 py-2 text-xs font-semibold text-cream/70 hover:bg-cream/10 hover:text-lime transition-all", children: [
...
function LiveClassesTab({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 shrink-0", children: [
          ...
          m.status === "live" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/live/$roomId", params: {
              roomId: m.roomId
            }, className: "rounded-full bg-red-500/20 text-red-300 px-4 py-2 text-xs font-bold flex items-center gap-1", children: [
    ...
    past.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DarkCard, { className: "p-0 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full min-w-[650px] text-sm", children: [
...
function TestsTab({
  ...
  const [pdfError, setPdfError] = reactExports.useState("");
  ...
  const handleDownloadQuiz = (q, format) => {
    const totalMarks2 = q.questions.reduce((s, quest) => s + quest.marks, 0);
    let htmlContent = `
      <div class="header">
        <h1>${cls.name}</h1>
        <h2>${q.title}</h2>
        <div class="meta">
          <span><strong>Total Marks:</strong> ${totalMarks2}</span>
  ...
  if (showBuilder) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
      ...
      pdfError && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border border-red-500/30 bg-red-500/10 px-4 py-3 text-sm text-red-300", children: pdfError }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
        ...
        })), className: "flex-1 rounded-2xl border-2 border-dashed border-lime/20 hover:border-lime/40 py-5 text-lime/70 hover:text-lime text-sm font-semibold flex items-center justify-center gap-2 transition-colors", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(LuPlus, { className: "h-4 w-4" }),
          " Add Question"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: `flex-1 rounded-2xl border-2 border-dashed border-lime/20 hover:border-lime/40 py-5 text-lime/70 hover:text-lime text-sm font-semibold flex items-center justify-center gap-2 transition-colors cursor-pointer ${isGeneratingPdf ? "opacity-50 pointer-events-none" : ""}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(LuUpload, { className: "h-4 w-4" }),
          " ",
          isGeneratingPdf ? "Generating..." : "Upload PDF (AI)",
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "file", accept: "application/pdf", className: "hidden", onChange: handlePdfUpload, disabled: isGeneratingPdf })
        ] })
      ] }),
...
function StudentsTab({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(DarkCard, { className: "p-0 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full min-w-[700px] text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-cream/5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "text-[10px] uppercase tracking-widest text-cream/60 text-left", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "p-4", children: "Student" }),
...
function AdminClassroomDetail() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 text-cream", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 overflow-x-auto bg-cream/5 rounded-2xl p-1.5 whitespace-nowrap [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden", children: TABS.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setTab(t.key), className: `shrink-0 inline-flex items-center justify-center gap-1.5 text-xs sm:text-sm font-semibold rounded-xl px-3.5 py-2 transition-colors ${tab === t.key ? "bg-lime text-plum-dark" : "text-cream/70 hover:text-cream"}`, children: [
